...
namespace Hangjing.Config
{
    ...
    public class MemCachedConfigInfo : IConfigInfo
    {
        ...
        private MemcachedConfigInfoHashingAlgorithm _hashingAlgorithm;
        /// <summary>
        /// 是否用nagle算法启动socket
        /// </summary>
        public MemcachedConfigInfoHashingAlgorithm HashingAlgorithm
        {
            get
            {
    ...
    ///</summary>
    public enum MemcachedConfigInfoHashingAlgorithm
    {
