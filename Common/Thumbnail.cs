...
namespace Hangjing.Common
{
    ...
    public class Thumbnail
    {
        ...
        //真正判断文件类型的关键函数
        public static bool IsAllowedUpload(Image img, string Thumbnailfilename)
        {
        ...
        public static bool MakeThumbnailImage(Image original, string newFileName)
        {
            bool issuccess = false;
            Size _newSize = ResizeImage(original.Width, original.Height, original.Width, original.Height);
