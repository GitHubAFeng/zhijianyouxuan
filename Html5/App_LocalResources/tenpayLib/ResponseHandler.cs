...
namespace tenpayApp
{
    ...
    */
	...
	{
		// 密钥 
		private string key = TenpayUtil.key;
        ...
        /// <returns></returns>
        public string getPostDataParameter(string parameter)
        {
        ...
        public virtual Boolean isTenpaySign() 
		{
            ...
            string sign = Utils.GetMD5(sb.ToString(), charset).ToUpper();
            this.setDebugInfo(sb.ToString() + " => sign:" + sign);

            string postsign = xmlMap["sign"].ToString().ToUpper();

            HJlog.toLog(this.getDebugInfo());
            HJlog.toLog("sign==" + postsign);

            return postsign.Equals(sign); 
		}
        ...
        public virtual Boolean isWXsign()
        {
            ...
            string sign = Utils.getSha1(sb.ToString()).ToString().ToLower();
