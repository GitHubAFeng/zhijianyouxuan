...
namespace Hangjing.Control
{
    ...
    public class TextBox : System.Web.UI.WebControls.TextBox, IWebControl
    {
                    ...
                    case "数据校验":
                        {
                            ...
                            RequiredFieldTypeREV.ErrorMessage = "<font color=red>数字的格式不正确</font>"; break;
                        }
                    case "正整数":
                        {
                            RequiredFieldTypeREV.ValidationExpression = (this.ValidationExpression != null) ? this.ValidationExpression : "^\\d*$";
                            RequiredFieldTypeREV.ErrorMessage = "<font color=red>请输入正整数</font>"; break;
                        }
                    case "电子邮箱":
                        {
                            ...
                            RequiredFieldTypeREV.ErrorMessage = "<font color=red>邮箱的格式不正确</font>"; break;
                        }
                    case "移动手机":
                        {
                            RequiredFieldTypeREV.ValidationExpression = (this.ValidationExpression != null) ? this.ValidationExpression : "\\d{11}";
                            RequiredFieldTypeREV.ErrorMessage = "<font color=red>手机的位数应为11位!</font>"; break;
                        }
                    case "家用电话":
                        {
                            ...
                            RequiredFieldTypeREV.ErrorMessage = "<font color=red>请依 (XXX)XXX-XXXX 格式或 (XXX)XXXX-XXXX 输入电话号码！</font>"; break;
                        }
                    case "身份证号码":
                        {   //(/(^\d{15}$)|(^\d{17}([0-9]|X)
                            RequiredFieldTypeREV.ValidationExpression = (this.ValidationExpression != null) ? this.ValidationExpression : "^\\d{15}$|^\\d{17}([0-9]|X)$";
                            RequiredFieldTypeREV.ErrorMessage = "<font color=red>请依15或18位数据的身份证号！</font>"; break;
                        }
                    case "驾驶证号码":
                        {
                            RequiredFieldTypeREV.ValidationExpression = (this.ValidationExpression != null) ? this.ValidationExpression : "^\\d{15}$|^\\d{12}|$^\\d{18}$";
                            RequiredFieldTypeREV.ErrorMessage = "<font color=red>请输入正确的驾驶证号！</font>"; break;
                        }
                    case "网页地址":
                        {
                            ...
                            RequiredFieldTypeREV.ErrorMessage = "<font color=red>请输入正确的网址</font>"; break;
                        }
                    case "日期":
                        {
                            ...
                            RequiredFieldTypeREV.ErrorMessage = "<font color=red>请输入正确的日期,如:2006-1-1</font>"; break;
                        }
                    case "日期时间":
                        {
                            ...
                            RequiredFieldTypeREV.ErrorMessage = "<font color=red>请输入正确的日期,如: 2006-1-1 23:59:59</font>"; break;
                        }
                    case "金额":
                        {
                            ...
                            RequiredFieldTypeREV.ErrorMessage = "<font color=red>请输入正确的金额</font>"; break;
                        }
                    case "营业时间":
                        {
                            RequiredFieldTypeREV.ValidationExpression = (this.ValidationExpression != null) ? this.ValidationExpression : @"^[0-9]{1,2}\:[0-9]{1,2}$";
                            RequiredFieldTypeREV.ErrorMessage = "<font color=red>时间格式错误，请按格式 12:00</font>"; break;
                        }
                    case "IP地址":
                        {
                            ...
                            RequiredFieldTypeREV.ErrorMessage = "<font color=red>请输入正确的IP地址</font>"; break;
                        }
                    case "IP地址带端口":
                        {
                            ...
                            RequiredFieldTypeREV.ErrorMessage = "<font color=red>请输入正确的带端口的IP地址</font>"; break;
                        }
                    case "多个号码":
                        {
                            RequiredFieldTypeREV.ValidationExpression = (this.ValidationExpression != null) ? this.ValidationExpression : @"^[0-9,]*$";
                            RequiredFieldTypeREV.ErrorMessage = "<font color=red>只能输入数字和‘,’</font>"; break;
                        }
                }
                ...
                case "必填":
                    {
                        ...
                        CanBeNullRFV.ErrorMessage = "<font color=red>请输入内容!</font>";
        ...
        public override int MaxLength
        {
            get
            {
                ...
                if (o != null)
                {
                    int maxlength = StringHelper.StrToInt(o.ToString(), 4);
    ...
    public class RequiredFieldTypeControlsConverter : StringConverter
    {
        ...
        public override System.ComponentModel.TypeConverter.StandardValuesCollection GetStandardValues(ITypeDescriptorContext context)
        {
            ...
            controlsArray.Add("营业时间");
            controlsArray.Add("金额");
            controlsArray.Add("IP地址");
            controlsArray.Add("IP地址带端口");
            controlsArray.Add("驾驶证号码");
            controlsArray.Add("多个号码");
