...
namespace Hangjing.SQLServerDAL
{
    ...
    public class TogoAddMoneyLog
    {
        ...
        public decimal GetNoUseMoney(string where)
        {
            ...
            sql += " from TogoAddMoneyLog where " + where;
        ...
        /// <param name="where"></param>
        /// <returns></returns>
        public TogoAddMoneyLogInfo getStatistics(string where)
        {
            string sql = "SELECT  SUM(AddMoney) as AddMoney  FROM dbo.TogoAddMoneyLog   where " + where;

            TogoAddMoneyLogInfo model = new TogoAddMoneyLogInfo();
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(TogoAddMoneyLogInfo model)
        {
            ...
            SQLHelper.ExecuteNonQuery(CommandType.StoredProcedure, "TogoAddMoneyLog_addmoney", parameters); ;
        ...
        /// 增加一条数据
        /// </summary>
        public int AddModel(TogoAddMoneyLogInfo model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into TogoAddMoneyLog(");
        ...
        /// 更新一条数据
        /// </summary>
        public int Update(TogoAddMoneyLogInfo model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update TogoAddMoneyLog set ");
        ...
        /// 此代码由杭景科技代码内部生成器自动生成
        /// <param>DataId</param>
        /// <returns>TogoAddMoneyLogInfo</returns>
        public TogoAddMoneyLogInfo GetModel(int DataId)
        {
            string sql = "select UserId,AddMoney,State,PayType,PayDate,PayState,AddDate,Inve1,Inve2 ,(select Name from points where unid = TogoAddMoneyLog.UserId) as TogoName from TogoAddMoneyLog where TogoAddMoneyLog.DataId=@DataId ";
            SqlParameter parameter = new SqlParameter("@DataId", SqlDbType.Int, 4);
            parameter.Value = DataId;
            TogoAddMoneyLogInfo model = null;
            using (SqlDataReader dr = SQLHelper.ExecuteReader(CommandType.Text, sql, parameter))
            {
                if (dr.Read())
                {
                    model = new TogoAddMoneyLogInfo();
        ...
        public int GetCount(string strWhere)
        {
            ...
            parameters[0].Value = "TogoAddMoneyLog";
        ...
        ///此代码由杭景科技代码内部生成器自动生成
        public IList<TogoAddMoneyLogInfo> GetList(int pagesize, int pageindex, string strWhere, string orderName, int orderType)
        {
            IList<TogoAddMoneyLogInfo> infos = new List<TogoAddMoneyLogInfo>();
            SqlParameter[] parameters =
            {
            ...
            parameters[0].Value = "TogoAddMoneyLog";
            parameters[1].Value = "DataId,UserId,AddMoney,State,PayType,PayDate,PayState,AddDate,Inve1,Inve2,(select Name from points where unid=TogoAddMoneyLog.UserId) as TogoName,(select AdminName from EAdmin where id=TogoAddMoneyLog.State) as admin";
        ...
        /// 此代码由杭景科技代码内部生成器自动生成
        /// <returns></returns>
        public int DelTogoAddMoneyLog(int Id)
        {
            StringBuilder str = new StringBuilder();
            str.Append("delete from TogoAddMoneyLog where DataId=@DataId");
            SqlParameter[] Para =
            {
        ...
        {
            StringBuilder str = new StringBuilder();
            str.Append("delete from TogoAddMoneyLog where DataId in ({0})");
        ...
        /// 更新一条数据
        /// </summary>
        public int UpdatePayState(TogoAddMoneyLogInfo model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update TogoAddMoneyLog set ");
            strSql.Append("State=@State,");
        ...
        /// 支付宝回调成功
        /// </summary>
        public int CallBlackByAli(TogoAddMoneyLogInfo model)
        {
            SqlParameter[] parameters =
            {
