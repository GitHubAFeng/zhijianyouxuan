...
namespace Hangjing.SQLServerDAL
{
    ...
    /// /商家结算的帐号信息（银行支付宝等）
    /// </summary>
    public partial class shopsettleaccount
    {

        /// <summary>
        /// 增加一条数据
        /// </summary>
        public int Add(shopsettleaccountInfo model)
        {
            ...
            return HJConvert.ToInt32(SQLHelper.ExecuteNonQuery(CommandType.StoredProcedure, "shopsettleaccount_ADD", parameters));
        }
        ...
        /// 更新一条数据
        /// </summary>
        public int Update(shopsettleaccountInfo model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update shopsettleaccount set ");
        ...
        /// 此代码由杭景科技代码内部生成器自动生成
        /// <param>Id</param>
        /// <returns>shopsettleaccountInfo</returns>
        public shopsettleaccountInfo GetModel(int Id)
        {
            string sql = "select Id,shopid,bankname,bankusername,aliaccount,aliname,remark,opuser,optime,reveint1,reveint2,reveint3,reveint4,reveint5,revefloat1,revefloat2,revefloat3,revevar1,revevar2,revevar3,revevar4,revevar5,revetext from shopsettleaccount where  Id = @Id";
            SqlParameter parameter = new SqlParameter("@Id", SqlDbType.Int, 4);
            parameter.Value = Id;
            shopsettleaccountInfo model = null;
            using (SqlDataReader dr = SQLHelper.ExecuteReader(CommandType.Text, sql, parameter))
            {
                if (dr.Read())
                {
                    model = new shopsettleaccountInfo();
        ...
        {
            return (int)SQLHelper.ExecuteScalar(CommandType.StoredProcedure, "pagecount", new SqlParameter("@tblName", "shopsettleaccount"), new SqlParameter("@strWhere", strWhere));
        }
        ...
        ///此代码由杭景科技代码内部生成器自动生成
        public IList<shopsettleaccountInfo> GetList(int pagesize, int pageindex, string strWhere, string orderName, int orderType)
        {
            IList<shopsettleaccountInfo> infos = new List<shopsettleaccountInfo>();
            SqlParameter[] parameters = 
			{
            ...
            parameters[0].Value = "shopsettleaccount";
        ...
        /// 此代码由杭景科技代码内部生成器自动生成
        /// <returns></returns>
        public int Delshopsettleaccount(int Id)
        {
            StringBuilder str = new StringBuilder();
            str.Append("delete from shopsettleaccount where Id=@Id");
            SqlParameter[] Para = 
			{
        ...
        {
            StringBuilder str = new StringBuilder();
            str.Append("delete from shopsettleaccount where Id in ({0})");
