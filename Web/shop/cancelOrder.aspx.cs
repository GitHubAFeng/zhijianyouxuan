...
public partial class shop_cancelOrder : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.Page.IsPostBack)
        {
            ...
            SqlWhere += " and OrderStatus=8 ";

            if (para == null || para.IndexOf("oe") == -1)
            {
                string url = "cancelOrder.aspx?c=1";
                url += "&para1=oe1|";
                ...
                case "oe"://催单或者退单状态
                    {
                        ...
                        {
                            case "1"://待处理
                                SqlWhere += " and (Custorder.shopCancel  IS NULL or Custorder.shopCancel=0) ";
                                break;
                            case "2"://已处理
                                SqlWhere += "  and Custorder.shopCancel in(1,2) ";
                                break;
                        }
                    }
                    break;
