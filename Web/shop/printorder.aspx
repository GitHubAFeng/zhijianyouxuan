<%@ Page Language="C#" AutoEventWireup="true" CodeFile="printorder.aspx.cs" Inherits="shop_printorder" %>
                        ...
                        <asp:Repeater runat="server" ID="Repeater1" DataSource='<%# getproduct(Eval("orderid")) %>'>
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td class="">
                                        ￥<%# Convert.ToDecimal( Eval("foodPrice")) %>
                                    </td>
                                    <td>
                                        ￥<%# Convert.ToDecimal(Eval("foodPrice")) * Convert.ToInt32(Eval("FCounts"))%>
                                    </td>
                                </tr>
                            </ItemTemplate>
                        </asp:Repeater>
