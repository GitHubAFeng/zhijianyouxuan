<%@ Page Language="C#" AutoEventWireup="true" CodeFile="showMenu.aspx.cs" Inherits="qy_54shoptss_Admin_Service_showMenu" %>
                ...
                <div class="indis_right_top">
                    <div class="infaq_list_title" style="line-height: 60px; height: 50px">
                        ...
                        <div style="float: left;">
                            <span>送达时间：<font runat="server" id="strongsendtime">0</font>分钟</span> <span style="padding-left: 10px;">
                                起送额：<font runat="server" id="strongRemark">0</font>元</span> <span style="padding-left: 10px;">
                                    送餐费：<font runat="server" id="strongsendcount">0</font>元</span></div>
                    </div>
                    <div>
