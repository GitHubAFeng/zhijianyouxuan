<%@ Page Language="C#" AutoEventWireup="true" CodeFile="citydetail.aspx.cs" Inherits="qy_54tss_Admin_manage_citydetail" %>
                                                            ...
                                                            <table class="form-list" cellspacing="0">
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                            <td class="label">
                                                                                <label for="_accountwebsite_id">
                                                                                    抽成设置 <span class="required">*</span></label>
                                                                            </td>
                                                                            <td class="value">   
                                                                                                                                                         
                                                                                <epc:TextBox runat="server" id="tbratio" CanBeNull="必填" Width="60"></epc:TextBox>%
                                                                                （按百分比提成） 
                                                                            </td>
                                                                            <td>
                                                                                <small>&nbsp;</small>
