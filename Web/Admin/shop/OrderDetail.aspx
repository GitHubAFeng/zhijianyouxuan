<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OrderDetail.aspx.cs" Inherits="Admin_shop_OrderDetail" %>
                                                                        ...
                                                                        <table class="form-list" cellspacing="0">
                                                                            <tbody>
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="value">
                                                                                        <epc:TextBox runat="server" Enabled="false" ID="tbOrderId" CanBeNull="必填" Width="200px" class="required-entry input-text"></epc:TextBox>
                                                                                    </td>
                                                                                    <td>
                                                                                        <small>&nbsp;</small>
                                                                                    </td>
                                                                        ...
                                                                        <table class="form-list" cellspacing="0">
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="value">
                                                                                        <epc:TextBox runat="server" ID="tbpakcage" Enabled="false" CanBeNull="必填" Width="60px"
                                                                                            class="required-entry input-text" Text=""></epc:TextBox>元
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="value">
                                                                                        <epc:TextBox runat="server" ID="tbsendfree" CanBeNull="必填" Width="60px" class="required-entry input-text" Text=""></epc:TextBox>元
                                                                                    </td>
                                                                                    <td>
                                                                                        <small>&nbsp;</small>
                                                                                    </td>
                                                                                ...
                                                                                <tr runat="server" id="paysttetr">
                                                                                    ...
                                                                                    <td class="value" style="width: 300px">
                                                                                        ...
                                                                                        <label runat="server" id="lbpayorderid" style="color: red;"></label>
                                                                                    </td>
                                                                                    <td>
                                                                                        <small>&nbsp;</small>
                                                                                    </td>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="value">
                                                                                        <epc:TextBox runat="server" ID="lblpaymoney" Enabled="false" class="required-entry input-text" Width="120px"></epc:TextBox>元
                                                                                    </td>
                                                                                    <td>
                                                                                        <small>&nbsp;</small>
                                                                                    </td>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="value">
                                                                                        <epc:TextBox runat="server" ID="Textstatr" Enabled="false" class="required-entry input-text" Width="200px"></epc:TextBox>
                                                                                    </td>
                                                                                    <td>
                                                                                        <small>&nbsp;</small>
                                                                                    </td>
