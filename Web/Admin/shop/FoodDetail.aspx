<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FoodDetail.aspx.cs" Inherits="Admin_shop_FoodDetail"
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        $(document).ready(function () { WhitchActive(2); getFullPrice(); MaxPerDayShow() });
        ...
        function getFullPrice() {
            var spicel = $("input[name='rblSpecial']:checked").val().trim();
            if (spicel == "1") {
                $("#FullPrice").show();
            }
            else {
                                                                ...
                                                                <table class="form-list" cellspacing="0">
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="value">
                                                                                <span>
                                                                                    <epc:TextBox runat="server" ID="tbFoodNamePy" name="invalue" Width="260" class="required-entry input-text"></epc:TextBox>
                                                                                </span>
                                                                            </td>
                                                                            <td>
                                                                                <small>&nbsp;</small>
                                                                        ...
                                                                        <tr style="display: none;">
                                                                            <td class="label">
                                                                                <label for="_accountfirstname">
                                                                                    商家推荐 <span class="required">*</span></label>
                                                                            </td>
                                                                            <td class="value">
                                                                        ...
                                                                        <tr>
                                                                            <td class="label">
                                                                                <label for="_accountfirstname">
                                                                                    今日特价 <span class="required">*</span></label>
                                                                            </td>
                                                                            <td class="value">
                                                                                <asp:RadioButtonList runat="server" ID="rblSpecial" onchange="getFullPrice()" RepeatDirection="Horizontal">
                                                                                    <asp:ListItem Value="1">是</asp:ListItem>
                                                                        ...
                                                                        <tr style="display: none;" id="FullPrice">
                                                                            <td class="label">
                                                                                <label for="_accountfirstname">
                                                                                    原价 <span class="required">*</span></label>
                                                                            </td>
                                                                            <td class="value">
                                                                                <epc:TextBox runat="server" name="invalue" Text="0" ID="tboldprice" CanBeNull="必填" Width="60px" RequiredFieldType="数据校验" class="required-entry input-text"></epc:TextBox>元
                                                                            </td>
                                                                            <td>
                                                                                <small>&nbsp;</small>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="value">
                                                                                <epc:TextBox runat="server" name="invalue" Text="0" ID="tbFullPrice" CanBeNull="必填" Width="60px" RequiredFieldType="数据校验" class="required-entry input-text"></epc:TextBox>元
                                                                            </td>
                                                                            <td>
                                                                                <small>&nbsp;</small>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            <td class="label">
                                                                                <label for="_accountfirstname">
                                                                                    月销量 <span class="required">*</span></label>
                                                                            </td>
                                                                            <td class="value">
                                                                                <epc:TextBox runat="server" name="invalue" Text="0" ID="tbRemains" CanBeNull="必填" Width="60px" RequiredFieldType="数据校验" class="required-entry input-text"></epc:TextBox>
                                                                            </td>
                                                                            <td>
                                                                                <small>&nbsp;</small>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="value">
                                                                                <epc:TextBox runat="server" name="invalue" ID="tbOrderNum" CanBeNull="必填" Width="60px" HintInfo="整数" RequiredFieldType="数据校验" class="required-entry input-text" Text="0"></epc:TextBox>
                                                                                <div class="mynotice">
                                                                                    数字大，排在前
                                                                                </div>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="value">
                                                                                ...
                                                                                <img border="0" src="../Images/System/wutu1.gif" id="ImgUrl" alt="" style="width: 200px; height: 200px" runat="server" /><br />
                                                                                ...
                                                                                <div id="rowTest" style="display: none">
                                                                                    <iframe name="tag" src="../upfile/Upload.html?Links" style="width: 340px; height: 130px" frameborder="0" scrolling="no" onload="this.height=document.body.scrollHeight"></iframe>
                                                                                </div>
                                                                                <div id="Upload">
                                                                                </div>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="value">
                                                                                <asp:TextBox runat="server" ID="tbtaste" size="" class="input_on" TextMode="MultiLine" Width="300px" Height="100px"></asp:TextBox>
                                                                            </td>
                                                                            <td>
                                                                                <small>&nbsp;</small>
                                                                            </td>
