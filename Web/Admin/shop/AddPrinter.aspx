<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddPrinter.aspx.cs" Inherits="qy_54tss_Admin_Shop_AddPrinter" %>
                                                                ...
                                                                <table class="form-list" cellspacing="0">
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="value">
                                                                                <epc:TextBox runat="server" ID="tbName" name="invalue" CanBeNull="必填" Width="200px" class="required-entry input-text"></epc:TextBox>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="value">
                                                                                <epc:TextBox runat="server" ID="tbPrinterNum" name="invalue" Width="200px" class="required-entry input-text" onblur="GetPrinterSn()"></epc:TextBox>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="value">
                                                                                <epc:TextBox runat="server" ID="tbPrinterSn" name="invalue"
                                                                                    Width="200px" class="required-entry input-text"></epc:TextBox>
                                                                            </td>
