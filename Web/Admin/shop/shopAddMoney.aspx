<%@ Page Language="C#" AutoEventWireup="true" CodeFile="shopAddMoney.aspx.cs"
    Inherits="qy_54tss_Admin_User_shopAddMoney" %>
...
<head id="Head1" runat="server">
    <title>人工充值或者扣款管理-<%= WebUtility.GetMyName() %></title>
                                    ...
                                    <div class="main-col-inner">
                                        ...
                                        <div style="visibility: visible;" class="content-header">
                                            <h3 class="icon-head head-customer">
                                                <asp:Label runat="server" ID="pageType">人工充值或者扣款</asp:Label></h3>
                                            <div style="width: 0px; height: 17px;" class="content-buttons-placeholder">
                                                <p style="" class="content-buttons form-buttons">
                                                    <asp:Button ID="Button1" runat="server" CssClass="button_1" OnClientClick="gourl('shopAddMoneyLog.aspx?tid='+Request('tid'));return false;"
                                                        Text="返回"></asp:Button>
                                            ...
                                            <div id="customer_info_tabs_account_content" style="">
                                                <div class="entry-edit">
                                                    <div class="entry-edit-head">
                                                        <h4 class="icon-head head-billing-address">操作信息</h4>
                                                    </div>
                                                    <fieldset class="np">
                                                                    ...
                                                                    <table class="form-list" cellspacing="0">
                                                                        <tbody>
                                                                            ...
                                                                            <tr style="width: 300px;">
                                                                                <td class="label">
                                                                                    <label for="_accountprefix">
                                                                                        涉及金额<span class="required">*</span></label>
                                                                                </td>
                                                                                <td class="value" style="width: 500px;">
                                                                                    ...
                                                                                    <div class=" notice">提示：金额大于0表示收入，小于0表示支出</div>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td class="value">
                                                                                    <epc:TextBox runat="server" ID="tbinve2" class="required-entry input-text" Width="300px"
                                                                                        TextMode="MultiLine" Height="60px"  CanBeNull="必填"></epc:TextBox>
                                                                                </td>
                                                                                <td>
                                                                                    <small>&nbsp;</small>
                                                                                </td>
