<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ShopList.aspx.cs" Inherits="Admin_Shop_ShopList" %>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <asp:DropDownList ID="ddlstar" runat="server">
                                                         ...
                                                         <asp:DropDownList runat="server" ID="ddlIsCallCenter" >
                                                                <asp:ListItem Value="-1" Text="商家类型"></asp:ListItem>
