<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ShopDetail.aspx.cs" Inherits="Admin_Shop_ShopDetail"
                                    ...
                                    <div class="main-col-inner">
                                        ...
                                        <ul id="diagram_tab" class="tabs-horiz" style="border-bottom: none" runat="server">
                                            ...
                                            <li><a href="ShopLocal.aspx?tid=<%= Request["id"] %>" class="tab-item-link "><span>
                                             ...
                                             <li><a href="ShopPicList.aspx?tid=<%= Request["id"] %>" class="tab-item-link "><span>
                                            ...
                                            <li><a href="settlecount.aspx?tid=<%= Request["id"] %>" class="tab-item-link "><span>
                                             ...
                                             <li><a href="shopAddMoneyLog.aspx?tid=<%= Request["id"] %>" class="tab-item-link "><span>
                                                <span class="changed"></span><span class="error"></span>商家收支记录</span> </a></li>

                                            <li style="display: <%= SectionProxyData.GetSetValue(18).ToString().Trim()== "0" ? "none" :""  %>;"><a href="shopPromotion.aspx?tid=<%= Request["id"] %>" class="tab-item-link "><span>
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            <tr>
                                                                              ...
                                                                              <tr >
                                                                                ...
                                                                                <td class="value">
                                                                                    <epc:TextBox runat="server" ID="tbMoney" Width="60px" Enabled="false" Text="0" class="required-entry input-text"></epc:TextBox>元
                                                                                </td>
                                                                            </tr>
                                                                            ...
                                                                            <tr>
                                                                              ...
                                                                              <tr>
                                                                                <td class="left_td">
                                                                                    <label for="_accountprefix">
                                                                                        商家类型：<span class="required">*</span></label>
                                                                                </td>
                                                                                <td class="value">
                                                                                    <asp:DropDownList runat="server" ID="ddlIsCallCenter" Width="100px">
                                                                                        <asp:ListItem Value="0" Text="外卖"></asp:ListItem>
                                                                                        <asp:ListItem Value="1" Text="超市"></asp:ListItem>
                                                                                    </asp:DropDownList>

                                                                                    <div class="notice">提示：一个城市只能一个超市类型的商家</div>
                                                                            ...
                                                                            <tr>
                                                                              ...
                                                                              <tr>
                                                                                <td class="left_td">
                                                                                    <label for="_accountprefix">
                                                                                        分销比例：<span class="required">*</span></label>
                                                                                </td>
                                                                                <td class="value">
                                                                                    <epc:TextBox runat="server" ID="tbSN2" RequiredFieldType="数据校验" CanBeNull="必填" Width="60px" Text="0" class="required-entry input-text"></epc:TextBox>%

                                                                                    <div class="notice">指用订单中商品金额的百分比用户于分销</div>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td class="value">
                                                                                    <epc:TextBox runat="server" ID="tbSortNum" CanBeNull="必填" Width="60px" RequiredFieldType="正整数"
                                                                                        class=" required-entry input-text" Text="1"></epc:TextBox>
                                                                                    <div class="mynotice">
                                                                                        数字大的排在前
                                                                                    </div>
                                                                                </td>
                                                                    ...
                                                                    <table class="form-list" cellspacing="0">
                                                                        <tbody>
                                                                            <tr>
                                                                                <td class="left_td">
                                                                                    <label for="_accountprefix">
                                                                                        订单刷新时间间隔：<span class="required"></span></label>
                                                                                </td>
                                                                                <td class="value">
                                                                                    <epc:TextBox runat="server" ID="tbRefresh" Width="30px" class="required-entry input-text" RequiredFieldType="正整数"  Text="30"></epc:TextBox> 秒/次
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td class="left_td">
                                                                            ...
                                                                            <tr style="display: none">
                                                                                <td class="value" colspan="2">
                                                                                    <FCKeditorV2:FCKeditor ID="tbIntroduce" runat="server" ToolbarSet="ShopDetail" BasePath="../fckeditor/"
