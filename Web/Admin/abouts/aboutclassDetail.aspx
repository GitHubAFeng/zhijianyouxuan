<%@ Page Language="C#" AutoEventWireup="true" CodeFile="aboutclassDetail.aspx.cs" Inherits="Admin_abouts_aboutclassDetail" %>
...
<head id="Head1" runat="server">
    <title>关于我们分类-<%= WebUtility.GetMyName()%></title>
                                    ...
                                    <div style="visibility: visible;" class="content-header">
                                        ...
                                        <div style="width: 0px; height: 17px;" class="content-buttons-placeholder">
                                            <p style="" class="content-buttons form-buttons">
                                                ...
                                                <button type="button" class="scalable " onclick="reset()" style="">
                                                    <span>重置</span></button>
                                                                ...
                                                                <table class="form-list" cellspacing="0">
                                                                    <tbody>
                                                                        <tr>
                                                                            <td class="label">
                                                                                <label for="_accountprefix">
                                                                                    分类信息名称<span class="required">*</span></label>
                                                                            </td>
                                                                            <td class="value">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="value">
                                                                                <epc:TextBox runat="server" ID="tborder" CanBeNull="必填" Width="400px" RequiredFieldType="数据校验"></epc:TextBox>
                                                                            </td>
                                                                            <td>
                                                                                <small>&nbsp;</small>
                                                                            </td>
