...
<cfset lang         = "en_US">
<cfset aspell_opts  = "-a --lang=#lang# --encoding=gb2312 -H --rem-sgml-check=alt">
...
<cffile action="write" file="#tempfile_in#" output="#text#" charset="gb2312">

<!--- execute aspell in an gb2312 console and redirect output to a file. gb2312 encoding is lost if done differently --->
...
<cffile action="read" file="#tempfile_out#" variable="food" charset="gb2312">
