<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WebMessageLogDetail.aspx.cs"
    Inherits="Admin_WebMessageLogDetail" %>
...
<head id="Head1" runat="server">
    <title>站内信记录管理-<%= WebUtility.GetMyName()%></title>
                                                                ...
                                                                <table class="form-list" cellspacing="0">
                                                                    <tbody>
                                                                        <tr>
                                                                            ...
                                                                            <td class="value">
                                                                                <epc:TextBox runat="server" ID="tbname" name="invalue" Width="200px" CanBeNull="必填"
