<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ordersourcelist.aspx.cs" Inherits="Admin_shop_ordersourcelist" %>
...
<head id="Head1" runat="server">
    <title>充值优惠管理-<%= WebUtility.GetMyName()%></title>
                                        ...
                                        <div class="hor-scroll">
                                            ...
                                            <asp:GridView ID="rptsubItem" runat="server" CssClass="GridViewStyle" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="充值">
                                                        ...
                                                        <EditItemTemplate>
                                                            <epc:TextBox ID="Lbl_classname" Text='<%#Eval("classname")%>' runat="server"></epc:TextBox></EditItemTemplate>
                                                    </asp:TemplateField>

                                                     <asp:TemplateField HeaderText="赠送">
                                                        <ItemStyle HorizontalAlign="Center" Width="20%" />
                                                        <ItemTemplate>
                                                            <%#Eval("status")%>
                                                        </ItemTemplate>
                                                        <EditItemTemplate>
                                                            <epc:TextBox ID="tbstatus" Text='<%#Eval("status")%>' Width="60"  onkeypress="return only_num(event)"  runat="server"></epc:TextBox></EditItemTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText="排序">
                                                        ...
                                                        <EditItemTemplate>
                                                            <epc:TextBox ID="Lbl_priority" Text='<%#Eval("Priority")%>' Width="60"  onkeypress="return only_num(event)"  runat="server"></epc:TextBox></EditItemTemplate>
                                                    </asp:TemplateField>
                                            ...
                                            <div id="nodata" runat="server" style="display: none;">
                                             ...
                                             <div align="center" style="margin-top: 20px; background: #6f8992; text-align: center; line-height: 24px; height: 24px;">
                                                    <label runat="server" id="Label2" style="font-size: 14px; color: #fff;">
                                                        添加优惠
                                                    </label>
                                                </div>
                                                ...
                                                <table style=" width: 100%;">
                                                    <tr>
                                                        <td style=" text-align: left; " colspan="2">
                                                             充值<epc:TextBox runat="server" ID="tbclassname"  RequiredFieldType="正整数"  Width="60" Text="0"></epc:TextBox>元 赠送<epc:TextBox runat="server" ID="tbStatus" Width="60" Text="0" RequiredFieldType="正整数" onkeypress="return only_num(event)"></epc:TextBox>元
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td style="text-align:left; width:50%;">
                                                             ...
                                                             排序：<epc:TextBox Width="60" Text="1" runat="server" ID="tbpri" onkeypress="return only_num(event)"></epc:TextBox><div
                                                                class="mynotice">
                                                                数字大，排序在前</div>
                                                        </td>
                                                        <td>
