<%@ Page Language="C#" AutoEventWireup="true" CodeFile="login.aspx.cs" Inherits="qy_54tss_Admin_login"
    ...
    <div class="navbar">
        <div class="navbar-inner">
            ...
            <a class="brand" href="javascript:"><span class="second">
                <%= SectionProxyData.GetSetValue(2) %>管理平台</span></a>
        </div>
    </div>
    <div class="row-fluid">
        ...
        <div class="dialog">
            <div class="block">
                ...
                <div class="block-body">
                    ...
                    <label>
                        验证码</label>
                    <input id="tbvcode" runat="server" type="text" class=""><img src="VCode.aspx" onclick="this.src = 'VCode.aspx?t='+new Date().getTime();"
            ...
            <p style=" color:Red;" class="pull-right">
                请使用firefox浏览器访问，<a target="blank" href="http://www.firefox.com.cn/download/">下载地址</a></p>
        </div>
        </form>
    </div>
