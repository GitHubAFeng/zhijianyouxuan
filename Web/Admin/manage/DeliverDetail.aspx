<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DeliverDetail.aspx.cs" Inherits="qy_55tuan_Admin_DeliverDetail" %>
                                                                    ...
                                                                    <table class="form-list" cellspacing="0">
                                                                        <tbody>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td class="value">
                                                                                    <epc:TextBox runat="server" ID="tbName" CanBeNull="必填" Width="160px" class="required-entry input-text"></epc:TextBox>
                                                                                </td>
                                                                                <td>
                                                                                    <small>&nbsp;</small>
                                                                                </td>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td class="value">
                                                                                    <epc:TextBox runat="server" ID="tbUserName" Width="160px" class=" required-entry input-text"></epc:TextBox>
                                                                                </td>
                                                                                <td>
                                                                                    <small>&nbsp;</small>
                                                                                </td>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td class="value">
                                                                                    <epc:TextBox runat="server" ID="tbpassword" Width="160px" class=" required-entry input-text"></epc:TextBox>
                                                                                    <div class="mynotice">
                                                                                        如不修改密码留空即可
                                                                                    </div>
                                                                                </td>
