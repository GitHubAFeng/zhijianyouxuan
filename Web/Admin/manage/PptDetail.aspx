<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PptDetail.aspx.cs" Inherits="Admin_PptDetail" %>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td class="value">
                                                                                    <asp:DropDownList runat="server" ID="ddltype" >
                                                                                        ...
                                                                                        <asp:ListItem Value="2">微信首页（宽度大于480，高为90）</asp:ListItem>
                                                                                         <asp:ListItem Value="3">app首页（宽度大于480，宽高比为3:1）</asp:ListItem>
