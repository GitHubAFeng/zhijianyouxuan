<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ShopCardUserRecord.aspx.cs" Inherits="Admin_card_ShopCardUserRecord" %>
...
<head id="Head1" runat="server">
    <title>优惠券使用记录-<%= WebUtility.GetMyName() %></title>
                                                    ...
                                                    <tr class="headings">
                                                        ...
                                                        <th>
                                                            <span class="nobr"><a href="#" name="real_order_id" title="asc" class="not-sort"><span
                                                                class="sort-title">优惠券券号</span></a></span>
                                                        </th>
                                                        <th>
                                                            <span class="nobr"><a href="#" name="real_order_id" title="asc" class="not-sort"><span
                                                        ...
                                                        <th>
                                                            <span class="nobr"><a href="#" name="created_at" title="asc" class="not-sort">
                                                                <!--sort-arrow-desc-->
                                                                <span class="sort-title">使用时间</span></a></span>
                                                        </th>
                                                    </tr>
                                                </thead>
