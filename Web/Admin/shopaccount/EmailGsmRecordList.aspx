<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EmailGsmRecordList.aspx.cs"
    Inherits="Admin_shopaccount_EmailGsmRecordList" %>
...
<head id="Head1" runat="server">
    <title>商家短信邮件营销记录管理-<%= WebUtility.GetMyName()%></title>
                                            ...
                                            <table class="data" cellspacing="0" id="grid_table">
                                                ...
                                                <thead>
                                                    ...
                                                    <tbody class="grid_data">
                                                        <asp:Repeater ID="rtpEmailRec" runat="server">
                                                            <ItemTemplate>
                                                                <tr class="pointer" title="">
                                                                    ...
                                                                    <td class=" last">
                                                                        <a href='EmailGsmRecDeTail.aspx?id=<%#Eval("DataId") %>'>编辑</a> |<asp:LinkButton
