<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserAddMoneyLog.aspx.cs"
    Inherits="Admin_Account_UserAddMoneyLog" %>

<%@ Register Src="~/Admin/Banner.ascx" TagName="TogoBanner" TagPrefix="uc1" %>
<%@ Register Assembly="AspNetPager" Namespace="Wuqi.Webdiyer" TagPrefix="webdiyer" %>
<%@ Register Src="~/Admin/Foot.ascx" TagName="Foot" TagPrefix="uc2" %>
<%@ Register TagPrefix="epc" Namespace="Hangjing.Control" Assembly="Hangjing.Control" %>
<%@ Register Src="~/Admin/Adleft.ascx" TagName="UserAddMoneyLog" TagPrefix="uc3" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>用户充值记录表-<%= WebUtility.GetMyName()%></title>
    ...
    <div class="wrapper">
        ...
        <div class="middle" id="anchor-content">
            <div id="page:main-container">
                <div class="columns ">
                    <uc3:UserAddMoneyLog ID="UserAddMoneyLog1" runat="server" />
                                    ...
                                    <div id="sales_order_grid_massaction" style="clear: both;">
                                        <table class="massaction" cellpadding="0" cellspacing="0">
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <a href="UserAddMoneyLogDetail.aspx">添加</a> <span class="separator">|</span> <a href="#"
                                                        ...
                                                        <asp:Repeater ID="rtpUserAddMoneyLog" runat="server" OnItemCommand="rtpUserAddMoneyLog_ItemCommand">
                                                            <ItemTemplate>
                                                                <tr class="pointer" title="">
                                                                    ...
                                                                    <td class=" last">
                                                                        <a href='UserAddMoneyLogDetail.aspx?id=<%#Eval("DataId") %>&uid=<%# Eval("UserId")%>'>
                                                                            编辑</a> |
