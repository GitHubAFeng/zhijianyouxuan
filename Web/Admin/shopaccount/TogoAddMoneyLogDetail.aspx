<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TogoAddMoneyLogDetail.aspx.cs" Inherits="Admin_shopaccount_TogoAddMoneyLogDetail" %>

<%@ Register Src="~/Admin/Banner.ascx" TagName="TogoBanner" TagPrefix="uc1" %>
<%@ Register Src="~/Admin/Foot.ascx" TagName="Foot" TagPrefix="uc2" %>
<%@ Register TagPrefix="epc" Namespace="Hangjing.Control" Assembly="Hangjing.Control" %>
<%@ Register Assembly="FredCK.FCKeditorV2" Namespace="FredCK.FCKeditorV2" TagPrefix="FCKeditorV2" %>
<%@ Register Src="~/Admin/Adleft.ascx" TagName="TogoAddMoneyLogDetail" TagPrefix="uc3" %>
...
<head id="Head1" runat="server">
 ...
 <%--<link href="../css/style.css" rel="stylesheet" type="text/css" />--%>
   ...
   <script language="javascript" type="text/javascript">
        ...
        {
            window.location.href = "TogoAddMoneyLogDetail.aspx";
        }
        function GotoADList()
        {
            window.location.href = "TogoAddMoneyLog.aspx";
        }
    </script>
            ...
            <div id="page:main-container">
                <div class="columns ">
                    <div class="side-col" id="page:left">
                     <uc3:TogoAddMoneyLogDetail ID="TogoAddMoneyLogDetail1" runat="server" />
                    </div> 
                                                                ...
                                                                <table class="form-list" cellspacing="0">
                                                                    <tbody>
                                                                         ...
                                                                         <tr>
                                                                            ...
                                                                            <td class="value">
                                                                                <epc:TextBox runat="server" ID="tbTogoName" CanBeNull="必填" Width="100px" class=" required-entry required-entry input-text"></epc:TextBox>
                                                                            </td>
                                                                            <td>
                                                                                <small>&nbsp;</small>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="value">
                                                                                <epc:TextBox runat="server" ID="tbAddMoney" CanBeNull="必填" Width="40px" RequiredFieldType="数据校验"  class=" required-entry required-entry input-text"></epc:TextBox>
                                                                            </td>
                                                                            <td>
                                                                                <small>&nbsp;</small>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            <td class="lable">
                                                                             ...
                                                                             <td class="value">
                                                                                <epc:TextBox runat="server" ID="tbAdddate" CanBeNull="必填" Width="100px" onfocus="WdatePicker({readOnly:true})"></epc:TextBox>
                                                                            </td>
                                                                            <td>
                                                                                <small>&nbsp;</small>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="value">
                                                                                <asp:DropDownList ID="ddlPayState" runat="server" Width="90px">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="value">
                                                                                <epc:TextBox runat="server" ID="tbNewAdddate" CanBeNull="必填" Width="100px" onfocus="WdatePicker({readOnly:true})"></epc:TextBox>
                                                                            </td>
                                                                            <td>
                                                                                <small>&nbsp;</small>
                                                                            </td> 
