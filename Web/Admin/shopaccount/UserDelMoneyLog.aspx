<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserDelMoneyLog.aspx.cs" Inherits="Admin_shopaccount_UserDelMoneyLog_" %>

<%@ Register Src="~/Admin/Banner.ascx" TagName="TogoBanner" TagPrefix="uc1" %>
<%@ Register Src="~/Admin/Foot.ascx" TagName="Foot" TagPrefix="uc2" %>
<%@ Register TagPrefix="epc" Namespace="Hangjing.Control" Assembly="Hangjing.Control" %>
<%@ Register Assembly="AspNetPager" Namespace="Wuqi.Webdiyer" TagPrefix="webdiyer" %>
<%@ Register Src="~/Admin/Adleft.ascx" TagName="UserDelMoneyLog" TagPrefix="uc3" %>
        ...
        <uc1:TogoBanner runat="server" ID="Banner" />
          <div class="middle" id="anchor-content">
            ...
            <div id="page:main-container">
                <div class="columns ">
                 <uc3:UserDelMoneyLog ID="UserDelMoneyLog1" runat="server" />
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" style="margin-left: 10px;">
                                            <tr>
                                                <td>
                                                 ...
                                                 <td>
                                                  <span>新增时间：</span>
                                                    <asp:TextBox ID="tb_Date1" runat="server" onfocus="WdatePicker()" class="input_new_style"
                                                        Width="75px"></asp:TextBox>
                                                      &nbsp;至&nbsp;
                                                    <asp:TextBox ID="tb_Date2" runat="server" onfocus="WdatePicker()" class="input_new_style"
                                                        Width="75px"></asp:TextBox>
                                                </td>
                                ...
                                <div id="sales_order_grid_massaction" style="clear: both;">
                                        <table class="massaction" cellpadding="0" cellspacing="0">
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <a href="UserDelMoneyLogDetail.aspx">添加</a> <span class="separator">|</span> <a href="#" onclick="javascript:Table.CheckAll()">
                                                            全选</a> <span class="separator">|</span> <a href="#" onclick="javascript:Table.CheckNo()">
                                                                取消选择</a><span class="separator">|</span> <a href="#" onclick="javascript:Table.ReCheck()">
                                                                    反向选择</a><span class="separator">|</span> <a href="#" onclick="return false">
                                                                        <asp:LinkButton runat="server" ID="lbDelsom" OnClientClick="return Del()">删除选定</asp:LinkButton>
                                                                    </a>
                                                    </td>
                                                    <td>
                                                    </td>
                                        ...
                                        <div class="hor-scroll">
                                            <table class="data" cellspacing="0" id="grid_table">
                                                    ...
                                                    <tr class="headings">
                                                        ...
                                                        <th>
                                                            <span class="nobr"><a class="not-sort" href="#" name="created_at" title="asc">
                                                                <span class="sort-title">消费名目</span></a></span>
                                                        </th>
                                                ...
                                                <tbody class="grid_data">
                                                    <asp:Repeater ID="rtpUserDelMoneyLog" runat="server" OnItemCommand="rtpUserDelMoneyLog_ItemCommand">
                                                        <ItemTemplate>
                                                            <tr class="pointer" title="">
                                                                <td class="" width="20px">
                                                                    <input class="massaction-checkbox" name="" type="checkbox" value='<%# Eval("UserId") %>'>
                                                                    </input>
                                                                </td>
                                                                <td class="">
                                                                    <%# Eval("UserId")%>
                                                                ...
                                                                <td class=" last">
                                                                    <a href='UserDelMoneyLogDetail.aspx?id=<%#Eval("DataId") %>'>编辑</a> |<asp:LinkButton ID="lbdel"
