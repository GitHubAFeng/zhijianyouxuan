<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TogoDelMoneyLog.aspx.cs"
    Inherits="Admin_Account_TogoDelMoneyLog" %>
...
<head id="Head1" runat="server">
    <title>商家消费记录-<%= WebUtility.GetMyName()%></title>
                                    ...
                                    <div id="sales_order_grid_massaction" style="clear: both;">
                                        <table class="massaction" cellpadding="0" cellspacing="0">
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <a href="TogoDelMoneyLogDetail.aspx">添加</a> <span class="separator">|</span> <a href="#"
                                            ...
                                            <table class="data" cellspacing="0" id="grid_table">
                                                ...
                                                <thead>
                                                    ...
                                                    <tbody class="grid_data">
                                                        <asp:Repeater ID="rtpTogoDelMoneyLog" runat="server" OnItemCommand="rtpTogoDelMoneyLog_ItemCommand">
                                                            <ItemTemplate>
                                                                <tr class="pointer" title="">
                                                                    ...
                                                                    <td class=" last">
                                                                        <a href='TogoDelMoneyLogDetail.aspx?id=<%#Eval("DataId") %>'>编辑</a> |<asp:LinkButton
