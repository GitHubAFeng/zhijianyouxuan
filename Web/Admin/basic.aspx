<%@ Page Language="C#" AutoEventWireup="true" CodeFile="basic.aspx.cs" Inherits="HomeDemo_basic" %>
                                            ...
                                            <fieldset class="a-center bold">
                                                <table style="width: 100%;">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button type="button" class="scalable back" onclick="setLocation('Shop/SearchOrder.aspx')"
                                                                style="">
                                                                <span>订单检索</span></button>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </fieldset>
                                            ...
                                            <fieldset class="a-center bold">
                                                <table style="width: 100%;">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button type="button" class="scalable back" onclick="setLocation('Shop/ShopList.aspx')"
                                                                style="">
                                                                <span>商家列表</span></button>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </fieldset>
                                        ...
                                        <div class="entry-edit">
                                            ...
                                            <fieldset class="a-center bold">
                                                <table style="width: 100%;">
                                                    <tr>
                                                        <td>
                                                            <button type="button" class="scalable" onclick="setLocation('Shop/SearchOrder.aspx')"
                                                                style="">
                                                                <span>订单检索</span></button>
                                                        </td>
                                                        <td>
                                                            <button type="button" class="scalable back" onclick="setLocation('Shop/webStatisticsYear.aspx')"
                                                                style="">
                                                                <span>订单统计</span></button>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </fieldset>
