<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WebMessageList.aspx.cs" Inherits="Admin_WebMessageList" %>
...
<head id="Head1" runat="server">
    <title>积分配置-<%= WebUtility.GetMyName()%></title>
                                                ...
                                                <thead>
                                                    <thead>
                                                        <tr class="headings">
                                                            ...
                                                            <th>
                                                                <span class="nobr"><a class="not-sort" href="#" name="real_order_id" title="asc"><span
                                                                    class="sort-title">站内信内容</span></a></span>
                                                            </th>
                                                            <th>
                                                    ...
                                                    <tbody class="grid_data">
                                                        <asp:Repeater ID="rptpWebMessage" runat="server"  OnItemCommand="rptpWebMessage_OnItemCommand">
                                                            <ItemTemplate>
                                                                <tr class="pointer" title="">
                                                                    ...
                                                                    <td class=" last">
                                                                        <a href='WebMessageDetail.aspx?id=<%#Eval("DataId") %>'>编辑</a>|
                                                                      <asp:LinkButton ID="lbdel" runat="server" CommandArgument='<%# Eval("DataId") %>'  CommandName="Del" OnClientClick="return confirm('确定要删除吗？');">删除</asp:LinkButton>
                                                                  </td>
                                                                </tr>
                                                            </ItemTemplate>
                                                        </asp:Repeater>
