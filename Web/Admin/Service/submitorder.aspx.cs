...
public partial class qy_54tss_Admin_Service_submitorder : System.Web.UI.Page
{
    ...
    protected void add_click(object sender, EventArgs e)
    {
        ...
        IList<Hangjing.Model.ROrderinfo> mylist = new OrderManager().submitOrder(Foods, infos, Context);
        if (mylist != null)
        {
