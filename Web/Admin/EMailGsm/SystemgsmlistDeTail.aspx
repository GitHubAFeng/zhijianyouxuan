<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SystemgsmlistDeTail.aspx.cs"
    Inherits="Admin_EMailGsm_SystemgsmlistDeTail" %>
...
<head id="Head1" runat="server">
    <title>查看商家邮件信息-<%= WebUtility.GetMyName()%></title>
                                                            ...
                                                            <div class="hor-scroll">
                                                                <table class="form-list" cellspacing="0">
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            <td class="lable">
                                                                                发送时间 <font color="#FF0000">*</font>：
                                                                            </td>
                                                                            <td class="value">
                                                                                <epc:TextBox runat="server" ID="tbSentTime" CanBeNull="必填"  onfocus="WdatePicker({readOnly:true})"
                                                                                    Width="90px" class=" required-entry required-entry input-text"></epc:TextBox>
                                                                            </td>
                                                                            <td>
                                                                                <small>&nbsp;</small>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="value">
                                                                                <epc:TextBox runat="server" ID="tbSum" CanBeNull="必填" RequiredFieldType="数据校验" Width="50px"
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="value">
                                                                                <epc:TextBox runat="server" ID="tbCdate" CanBeNull="必填" Width="160px" onfocus="WdatePicker({readOnly:true})"></epc:TextBox>
                                                                            </td>
                                                                            <td>
                                                                                <small>&nbsp;</small>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="value">
                                                                                <epc:TextBox runat="server" TextMode="MultiLine" Width="500px" Height="200px" ID="tbUserIdList"
