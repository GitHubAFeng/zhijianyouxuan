<%@ Page Language="C#" AutoEventWireup="true" CodeFile="userTOP10.aspx.cs" Inherits="Admin_Sale_userTOP10" %>
...
<head id="Head1" runat="server">
    <title>会员订餐TOP10-<%= WebUtility.GetMyName()%></title>
                        ...
                        <div class="main-col" id="content">
                            ...
                            <div class="main-col-inner">
                                ...
                                <ul class="tabs-horiz" runat="server" id="divop">
                                    <li><a href="userTOP10.aspx?on=ordercount" id="sort_ordercount" class="tab-item-link ">
                                        <span><span class="changed"></span><span class="error"></span>按订单量</span> </a>
                                    </li>

                                    <li><a href="userTOP10.aspx?on=TotalPrice" id="sort_TotalPrice" class="tab-item-link "><span>
                                        <span class="changed"></span><span class="error"></span>按总金额</span> </a></li>
