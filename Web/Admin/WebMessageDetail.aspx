<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WebMessageDetail.aspx.cs"
    Inherits="Admin_WebMessageDetail" %>
...
<head id="Head1" runat="server">
    <title>站内信管理-<%= WebUtility.GetMyName()%></title>
    ...
    <script language="javascript" type="text/javascript">
        ...
        $(window).load(function() { $("#loading-mask").hide(); showContent(8); });
        function reset()
        {
                                    ...
                                    <div style="visibility: visible;" class="content-header">
                                        ...
                                        <div style="width: 0px; height: 17px;" class="content-buttons-placeholder">
                                            <p style="" class="content-buttons form-buttons">
                                                <button type="button" class="scalable back" onclick='GotList()' style="">
                                                                ...
                                                                <table class="form-list" cellspacing="0">
                                                                    <tbody>
                                                                        <tr>
                                                                            ...
                                                                            <td class="value">
                                                                                <epc:TextBox runat="server" ID="tbTitle" name="invalue" CanBeNull="必填" Width="400px"
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="value">
                                                                                <epc:TextBox runat="server" ID="tbAddDate" name="invalue" Width="200px" CanBeNull="必填"
                                                                                    class=" required-entry required-entry input-text" onfocus="WdatePicker({readOnly:true})"></epc:TextBox>
                                                                            </td>
                                                                            <td>
                                                                                <small>&nbsp;</small>
                                                                            </td>
