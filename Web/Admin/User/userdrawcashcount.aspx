<%@ Page Language="C#" AutoEventWireup="true" CodeFile="userdrawcashcount.aspx.cs" Inherits="Admin_Shop_userdrawcashaccount"
...
<head id="Head1" runat="server">
    <title>提现账户-<%= WebUtility.GetMyName()%></title>
                                ...
                                <ContentTemplate>
                                    ...
                                    <div class="main-col-inner">
                                        ...
                                        <ul id="diagram_tab" class="tabs-horiz" style="border-bottom: none" runat="server">
                                            <li><a href="UserDetail.aspx?id=<%= Request["id"] %>" class="tab-item-link ">
                                            ...
                                            <div class="">
                                                <div class="entry-edit">
                                                    <div class="entry-edit-head">
                                                        <h4 class="icon-head head-billing-address">提现账户</h4>
                                                    </div>
                                                    <fieldset class="np">
                                                                    ...
                                                                    <table class="form-list" cellspacing="0">
                                                                        <tbody>
                                                                            <tr>
                                                                                ...
                                                                                <td class="value">
                                                                                    <epc:TextBox runat="server" ID="tbbankname"  Width="190px" class="required-entry input-text"></epc:TextBox>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td class="left_td">
                                                                                ...
                                                                                <td class="value">
                                                                                    <epc:TextBox runat="server" ID="tbbankusername" Width="190px" class="required-entry input-text"></epc:TextBox>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td class="left_td">
                                                                                ...
                                                                                <td class="value">
                                                                                    <epc:TextBox runat="server" ID="tbrevevar1"  Width="290px" class="required-entry input-text"></epc:TextBox>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td class="left_td">
                                                                            ...
                                                                            <tr>
                                                                             ...
                                                                             <tr>
                                                                                <td class="left_td">
                                                                                    <label for="_accountprefix">
                                                                                        微信账号：<span class="required"></span></label>
                                                                                </td>
                                                                                <td class="value">
                                                                                    <epc:TextBox runat="server" ID="tbopuser" Width="190px" class="required-entry input-text"
                                                                                        name="invalue"></epc:TextBox>
                                                                                </td>
                                                                            </tr>
