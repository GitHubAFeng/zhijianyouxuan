<%@ Page Language="C#" AutoEventWireup="true" CodeFile="userdrawcashrecords.aspx.cs" Inherits="Admin_shop_userdrawcashrecords" %>
                            ...
                            <div class="main-col-inner">
                                ...
                                <fieldset class="AdminSearchform">
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" style="margin-left: 10px; float: left"
                                        ...
                                        <tr>
                                            <td align="right">
                                                <span style="width: 160px;">会员ID： </span>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td align="right">
                                                <span style="width: 160px;">会员：</span>
                                            </td>
                                            <td>
                                                ...
                                                <table class="data" cellspacing="0" id="grid_table">
                                                    ...
                                                    <thead>
                                                        <tr class="headings">
                                                            ...
                                                            <th>
                                                                <span class="nobr"><a href="#" class="not-sort"><span class="sort-title">用户</span></a></span>
                                                            </th>
                                                            <th>
                                                            ...
                                                            <ItemTemplate>
                                                                <tr class="pointer" title="">
                                                                    ...
                                                                    <td class=" last">
                                                                        ...
                                                                        <div style="<%#Convert.ToInt32(Eval("state")) == 0 ? "": "display:none"%>" id="bt_box_<%# Eval("dataid")%>">
...
<script type="text/javascript"> 
    ...
    CashOutObject.prototype.SetState = function(state)
    {
        ...
        var para = "t=" + new Date().getTime() + "&id=" + id + "&method=setUserDrawCash&msg=" + escape(msg)+"&state="+state;
        showload_super();
        jQuery.ajax(
        {
            type: "post",
    ...
    function opOrder(cid,msgbox) {
        ...
        html += "<input type=\"button\" style=\"margin-left: 30px;\" value=\"打款\" onclick=\"obCashOut.SetState(1)\" /><input type=\"button\" style=\"margin-left: 30px; display:none; \" value=\"拒绝\" onclick=\"obCashOut.SetState(2)\" /></div></div>";
