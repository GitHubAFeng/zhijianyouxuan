<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserAddMoneyDetail.aspx.cs"
    Inherits="qy_54tss_Admin_User_UserAddMoneyDetail" %>
                                    ...
                                    <div style="visibility: visible;" class="content-header">
                                        ...
                                        <div style="width: 0px; height: 17px;" class="content-buttons-placeholder">
                                            <p style="" class="content-buttons form-buttons">
                                                <asp:Button ID="Button1" runat="server" CssClass="button_1" OnClientClick="gourl('UserAddMoneyLog.aspx?uid='+Request('uid'));return false;"
                                                    Text="返回"></asp:Button>
