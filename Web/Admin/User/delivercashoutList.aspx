<%@ Page Language="C#" AutoEventWireup="true" CodeFile="delivercashoutList.aspx.cs" Inherits="Admin_User_delivercashoutList" %>
                            ...
                            <div class="main-col-inner">
                                ...
                                <fieldset class="AdminSearchform">
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" style="margin-left: 10px; float: left"
                                        ...
                                        <tr>
                                            <td align="right">
                                                <span style="width: 160px;">骑士ID： </span>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td align="right">
                                                <span style="width: 160px;">骑士：</span>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList runat="server" ID="ddlstate" class="j_select">
                                                    ...
                                                    <asp:ListItem Text="骑士取消" Value="3"></asp:ListItem>
                                                </asp:DropDownList>
                                                ...
                                                <table class="data" cellspacing="0" id="grid_table">
                                                    ...
                                                    <thead>
                                                        <tr class="headings">
                                                            ...
                                                            <th>
                                                                <span class="nobr"><a href="#" class="not-sort"><span class="sort-title">骑士</span></a></span>
                                                            </th>
                                                            <th>
