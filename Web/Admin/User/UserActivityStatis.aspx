<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserActivityStatis.aspx.cs" Inherits="Admin_User_UserActivityStatis" %>
...
<head runat="server">
    <title>用户活跃度-<%= WebUtility.GetMyName()%></title>
                                ...
                                <ContentTemplate>
                                    <div class="main-col-inner">
                                        ...
                                        <fieldset class="AdminSearchform">
                                            <legend>每天都订餐的用户 </legend>
                                            <table border="0" cellpadding="0" cellspacing="0" style="margin-left: 10px;">
                                                <tr>
                                                    <td>
                                                        <asp:Button runat="server" ID="btday" class="form-button" Text="今天" OnClick="btday_Click" />
                                                        <asp:Button runat="server" ID="btSearch" class="form-button" Text="最近3天" OnClick="btSearch_Click" />
                                                        <asp:Button runat="server" ID="btSearchWork" class="form-button" Text="最近7天" OnClick="btSearchWork_Click" />
                                                        <asp:Button runat="server" ID="btSearchMonth" class="form-button" Text="最近30天" OnClick="btSearchMonth_Click" />
                                                    </td>
                                                </tr>
                                            </table>
                                        </fieldset>
                                                ...
                                                <table class="data" cellspacing="0" id="grid_table">
                                                    ...
                                                    <thead>
                                                        ...
                                                        <tbody class="grid_data">
                                                            <asp:Repeater ID="rptUserActivityStatis" runat="server">
                                                                <ItemTemplate>
