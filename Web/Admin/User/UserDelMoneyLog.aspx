<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserDelMoneyLog.aspx.cs"
    Inherits="Admin_user_UserDelMoneyLog_" %>
...
<head runat="server">
    <title>用户账户消费记录-<%= WebUtility.GetMyName()%></title>
                                    ...
                                    <fieldset class="AdminSearchform">
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" style="margin-left: 10px;">
                                            <tr>
                                                <td>
                                                    <span>用户名称</span>
                                                    <asp:TextBox ID="tb_UserId" runat="server" CssClass="j_text"></asp:TextBox>
                                                    &nbsp;
                                                    <span>时间：</span>
                                                    <asp:TextBox ID="tb_Date1" runat="server" onfocus="WdatePicker()" CssClass="j_text"
                                                        Width="75px"></asp:TextBox>
                                                    &nbsp;至&nbsp;
                                                    <asp:TextBox ID="tb_Date2" runat="server" onfocus="WdatePicker()" CssClass="j_text"
                                                        Width="75px"></asp:TextBox> &nbsp;
                                                </td>
                                                        ...
                                                        <asp:Repeater ID="rtpUserDelMoneyLog" runat="server" OnItemCommand="rtpUserDelMoneyLog_ItemCommand">
                                                            <ItemTemplate>
                                                                <tr class="pointer" title="">
                                                                    ...
                                                                    <td class=" last">
                                                                        <a href='UserDelMoneyLogDetail.aspx?id=<%#Eval("DataId") %>'>编辑</a> |<asp:LinkButton
