<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserDistributionList.aspx.cs"
    Inherits="qy_54tss_Admin_User_UserDistributionList" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function GotoAddFood() {
            window.location.href = "UserDistributionDetail.aspx?uid=" + document.getElementById("hidTogoId").value + "";
        }
                                    ...
                                    <div class="main-col-inner">
                                        ...
                                        <fieldset class="AdminSearchform" runat="server" id="userinfofieldset">
                                            ...
                                            <div style="clear: both; padding: 10px;">
                                                <span>分销账户余额:<span runat="server" id="lbmoney" style="margin-left: 20px; font-weight: bold; color: Red">0</span></span>
                                            </div>
                                        </fieldset>
                                        <div class="scott">
                                                                ...
                                                                <th>
                                                                  ...
                                                                  <th>
                                                                    <span class="nobr"><a href="#" name="billing_name" title="asc" class="not-sort"><span
                                                                        class="sort-title">流水号</span></a></span>
                                                                </th>
                                                                <th>
                                                                    <span class="nobr"><a href="#" name="billing_name" title="asc" class="not-sort"><span
                                                                        class="sort-title">用户</span></a></span>
                                                                </th>
                                                                <th>
                                                                    <span class="nobr"><a href="#" name="billing_name" title="asc" class="not-sort"><span
