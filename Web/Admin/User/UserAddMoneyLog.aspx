<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserAddMoneyLog.aspx.cs"
    Inherits="qy_54tss_Admin_User_UserAddMoneyLog" %>
...
<head id="Head1" runat="server">
    <title>充值记录-<%= WebUtility.GetMyName()%></title>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function GotoAddFood() {
            window.location.href = "UserAddMoneyDetail.aspx?uid=" + document.getElementById("hidTogoId").value + "";
        }
                                ...
                                <div class="main-col-inner">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <asp:DropDownList ID="ddlpaymodel" runat="server" class="j_select">
                                                        <asp:ListItem Value="-1">充值方式</asp:ListItem>
                                                        <asp:ListItem Value="1">网站</asp:ListItem>
                                                        <asp:ListItem Value="2">支付宝</asp:ListItem>
                                                    </asp:DropDownList>
                                                    <asp:DropDownList ID="ddlpaystate" runat="server" class="j_select">
                                                        <asp:ListItem Value="-2">状态</asp:ListItem>
                                                ...
                                                <td>
                                                    &nbsp; &nbsp;<asp:Button runat="server" ID="btSearch" class="form-button" Text="搜索"
                                                        OnClick="btSearch_Click" />
                                                </td>
                                                <td>
                                                    &nbsp; &nbsp;
                                                    <asp:Button runat="server" ID="btadd" class="form-button" Text="为此用户充值" OnClientClick="GotoAddFood();return false" />
                                                </td>
                                            </tr>
                                        </table>
                                    </fieldset>
                                    <fieldset class="AdminSearchform" runat="server" id="userinfofieldset">
                                        ...
                                        <div style="clear: both; padding: 10px;">
                                            <span>当前可用余额:<span runat="server" id="lbmoney" style="margin-left: 20px; font-weight: bold;
                                                color: Red">0</span></span>
                                        </div>
                                    </fieldset>
                                    <div class="scott">
                                                        ...
                                                        <tr class="headings">
                                                            ...
                                                            <th>
                                                                <span class="nobr"><a href="#" name="billing_name" title="asc" class="not-sort"><span
                                                                    class="sort-title">充值用户</span></a></span>
                                                            </th>
                                                            <th>
                                                                <span class="nobr"><a href="#" name="billing_name" title="asc" class="not-sort"><span
                                                            ...
                                                            <th>
                                                                <span class="nobr"><a href="#" name="billing_name" title="asc" class="not-sort"><span
                                                                    class="sort-title">充值时间</span></a></span>
                                                            </th>
                                                            <th>
                                                                <span class="nobr"><a href="#" name="billing_name" title="asc" class="not-sort"><span
                                                                    class="sort-title">充值方式</span></a></span>
                                                            </th>
                                                            <th>
                                                                <span class="nobr"><a href="#" name="billing_name" title="asc" class="not-sort"><span
                                                                    class="sort-title">备注</span></a></span>
                                                            </th>
                                                            <th>
                                                                <span class="nobr"><a href="#" name="billing_name" title="asc" class="not-sort"><span
                                                            ...
                                                            <th class="no-link last">
                                                                <span class="nobr" style="padding-top: 3px; *padding-top: 5px;">操作人</span>
                                                            </th>
                                                        </tr>
                                                    </thead>
                                                        ...
                                                        <asp:Repeater ID="rtpGifts" runat="server">
                                                            <ItemTemplate>
                                                                <tr class="pointer" title="">
                                                                    ...
                                                                    <td class="">
                                                                        <%# WebUtility.Recharge(Eval("paytype").ToString())%>
                                                                    </td>
                                                                    <td class="">
                                                                    ...
                                                                    <td class="">
                                                                        <%# WebUtility.TurnPayState(Eval("PayState").ToString())%>
                                                                    </td>
