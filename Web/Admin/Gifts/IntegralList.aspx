<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IntegralList.aspx.cs" Inherits="Admin_Integral_IntegralList" %>
...
<head id="Head1" runat="server">
    <title>礼品兑换管理-<%= WebUtility.GetMyName()%></title>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function getexcel(){
           var url= "SearchExcelGift.aspx?type=1";
           window.open(url);
        }
                                    ...
                                    <fieldset class="AdminSearchform">
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" class="condition_table">
                                            <tr>
                                                <td>
                                                    <span>会员ID：</span>
                                                    <asp:TextBox ID="tb_UserID" runat="server" CssClass="j_text" Width="120px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <span>用户名：</span>
                                                    <asp:TextBox ID="tb_UserName" runat="server" CssClass="j_text" Width="120px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <span>礼品ID：</span>
                                                    <asp:TextBox ID="tb_GiftID" runat="server" CssClass="j_text" Width="120px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <span>礼品名：</span>
                                                    <asp:TextBox ID="tb_GiftName" runat="server" CssClass="j_text" Width="120px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <span>兑换时间：</span>
                                                    <asp:TextBox ID="tbDate1" runat="server" onfocus="WdatePicker()" CssClass="j_text"
                                                        Width="85px"></asp:TextBox>
                                                    至
                                                    <asp:TextBox ID="tbDate2" runat="server" onfocus="WdatePicker()" CssClass="j_text"
                                                        Width="85px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <span>状态：</span>
                                                    <asp:DropDownList ID="ddl_State" runat="server" CssClass="j_seclect">
                                                        <asp:ListItem Value="-1">所有状态</asp:ListItem>
                                                        <asp:ListItem Value="0">未审核</asp:ListItem>
                                                        <asp:ListItem Value="1">审核通过</asp:ListItem>
                                                        <asp:ListItem Value="2">审核未通过</asp:ListItem>
                                                    </asp:DropDownList>
                                                    <asp:Button ID="btSearch" runat="server" class="form-button" OnClick="btSearch_Click"
                                                        Text="搜索" />
                                                    <asp:Button ID="btExport2" runat="server" class="form-button" OnClientClick="getexcel();return false;"
                                                        Text="导出" />
                                                </td>
                                            </tr>
                                        </table>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <a href="#" onclick="return false">
                                                            ...
                                                            <span class="separator">|</span><a href="#" onclick="return false">
                                                                <asp:LinkButton runat="server" ID="LinkButton1" OnClientClick="return jDel();" OnClick="reset_pwd">审核不通过</asp:LinkButton>
                                                            </a>
                                                    </td>
                                                    <td>
                                                    </td>
                                            ...
                                            <table class="data" cellspacing="0" id="grid_table">
                                                ...
                                                <thead>
                                                        ...
                                                        <tr class="headings">
                                                            ...
                                                            <th>
                                                                <span class="nobr"><a class="not-sort" href="#" name="real_order_id" title="asc"><span
                                                                    class="sort-title">用户ID</span></a></span>
                                                            </th>
                                                            <th>
                                                                <span class="nobr"><a class="not-sort" href="#" name="real_order_id" title="asc"><span
                                                            ...
                                                            <th>
                                                                <span class="nobr"><a class="not-sort" href="#" name="real_order_id" title="asc"><span
                                                                    class="sort-title">礼品ID</span></a></span>
                                                            </th>
                                                            <th>
                                                                <span class="nobr"><a class="not-sort" href="#" name="real_order_id" title="asc"><span
                                                                    class="sort-title">礼品名称</span></a></span>
                                                            </th>
                                                            <th>
                                                                <span class="nobr"><a class="not-sort" href="#" name="store_id" title="asc"><span
                                                                    class="sort-title">所用积分</span></a></span>
                                                            </th>
                                                            <th>
                                                                <span class="nobr"><a class="not-sort" href="#" name="created_at" title="asc">
                                                                    <!--sort-arrow-desc-->
                                                                    <span class="sort-title">兑换时间</span></a></span>
                                                            </th>
                                                            <th>
                                                                <span class="nobr"><a class="not-sort" href="#" name="created_at" title="asc">
                                                                    <!--sort-arrow-desc-->
                                                    ...
                                                    <tbody class="grid_data">
                                                        <asp:Repeater ID="rtpIntegral" runat="server" OnItemCommand="rtpIntegral_ItemCommand">
                                                            <ItemTemplate>
                                                                <tr class="pointer" title="">
                                                                    <td class="" width="20px">
                                                                        <input class="massaction-checkbox" name="" type="checkbox" value='<%# Eval("IntegralId") %>'>
                                                                        </input>
                                                                    </td>
                                                                    <td class="">
                                                                        <%# Eval("CustId")%>
                                                                    ...
                                                                    <td class=" last">
                                                                        <asp:LinkButton ID="lbdel" runat="server" CommandArgument='<%#Eval("IntegralId")+"_"+ Eval("CustId")%>'
                                                                            CommandName="Del" OnClientClick="return confirm('确定要删除吗？');">删除</asp:LinkButton>
                                                                        |<a href='IntegralDetail.aspx?id=<%#Eval("IntegralId") %>'>编辑</a> |
                                                                        <asp:LinkButton CommandName="pass" CommandArgument='<%#Eval("IntegralId")+"_"+ Eval("CustId")%>'
                                                                            runat="server" ID="LinkButton1">审核通过</asp:LinkButton>
                                                                    </td>
                                                                </tr>
                                                            </ItemTemplate>
                                                        </asp:Repeater>
