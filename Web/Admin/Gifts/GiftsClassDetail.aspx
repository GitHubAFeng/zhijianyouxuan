<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GiftsClassDetail.aspx.cs"
    Inherits="Admin_GiftsClass_GiftsClassDetail" %>
...
<head id="Head1" runat="server">
    <title>礼品分类-<%= WebUtility.GetMyName()%></title>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function GotoADList()
        {
            window.location.href = "GiftsClassList.aspx";
        }
    </script>
    ...
    <div class="wrapper">
        ...
        <div class="middle" id="anchor-content">
            <div id="page:main-container">
                <div class="columns ">
                    <uc3:GiftsClassleft ID="GiftsClassleft1" runat="server" />
                                                                ...
                                                                <table class="form-list" cellspacing="0">
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="value">
                                                                                <epc:TextBox runat="server" ID="tborder" Text="50" MaxLength="4" CanBeNull="必填" Width="50px"
                                                                                    RequiredFieldType="数据校验"></epc:TextBox><div class="mynotice">
                                                                                        数字大，排序在前</div>
                                                                            </td>
                                                                            <td>
                                                                                <small>&nbsp;</small>
