<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GiftsList.aspx.cs" Inherits="Admin_Gifts_GiftsList" %>
                                    ...
                                    <div id="sales_order_grid_massaction" style="clear: both;">
                                        <table class="massaction" cellpadding="0" cellspacing="0">
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <a href="GiftsDetail.aspx">添加</a> <span class="separator">|</span> <a href="#" onclick="javascript:Table.CheckAll()">
                                                        ...
                                                        <tr class="headings">
                                                            ...
                                                            <th>
                                                                <span class="nobr"><a class="not-sort" href="#" name="store_id" title="asc"><span
                                                                    class="sort-title">所需积分</span></a></span>
                                                            </th>
                                                            <th>
                                                                <span class="nobr"><a class="not-sort" href="#" name="created_at" title="asc">
                                                                    <!--sort-arrow-desc-->
                                                                    <span class="sort-title">礼品价值</span></a></span>
                                                            </th>
                                                        ...
                                                        <asp:Repeater ID="rtpGifts" runat="server" OnItemCommand="rtpGifts_ItemCommand">
                                                            <ItemTemplate>
                                                                <tr class="pointer" title="">
                                                                    <td class="" width="20px">
                                                                        <input class="massaction-checkbox" name="" type="checkbox" value='<%# Eval("GiftsId") %>'>
                                                                        </input>
                                                                    </td>
                                                                    <td class="">
                                                                        <%# Eval("GiftsId")%>
                                                                    ...
                                                                    <td class=" last">
                                                                        <a href='GiftsDetail.aspx?id=<%#Eval("GiftsId") %>'>编辑</a> |<asp:LinkButton ID="lbdel"
                                                                            runat="server" CommandArgument='<%# Eval("GiftsId") %>' CommandName="Del" OnClientClick="return DelConfirm();">删除</asp:LinkButton>
                                                                    </td>
                                                                </tr>
                                                            </ItemTemplate>
                                                        </asp:Repeater>
