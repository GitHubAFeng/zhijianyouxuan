<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GiftsClassList.aspx.cs" Inherits="Admin_GiftsClass_GiftsClassList" %>

<%@ Register Src="~/Admin/Banner.ascx" TagName="TogoBanner" TagPrefix="uc1" %>
<%@ Register Assembly="AspNetPager" Namespace="Wuqi.Webdiyer" TagPrefix="webdiyer" %>
<%@ Register Src="~/Admin/Foot.ascx" TagName="Foot" TagPrefix="uc2" %>
<%@ Register TagPrefix="epc" Namespace="Hangjing.Control" Assembly="Hangjing.Control" %>
<%@ Register Src="~/Admin/Adleft.ascx" TagName="GiftsClassleft" TagPrefix="uc3" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>礼品分类管理-<%= WebUtility.GetMyName()%></title>
    ...
    <div class="wrapper">
        ...
        <div class="middle" id="anchor-content">
            <div id="page:main-container">
                <div class="columns ">
                    <uc3:GiftsClassleft runat="server" />
                                    ...
                                    <div id="sales_order_grid_massaction" style="clear: both;">
                                        <table class="massaction" cellpadding="0" cellspacing="0">
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <a href="GiftsClassDetail.aspx">添加</a> <span class="separator">|</span> <a href="#"
                                        ...
                                        <div class="hor-scroll">
                                            <table class="data" cellspacing="0" id="grid_table">
                                                    ...
                                                    <tr class="headings">
                                                        ...
                                                        <th>
                                                            <span class="nobr"><a class="not-sort" href="#" name="real_order_id" title="asc"><span
                                                                class="sort-title">礼品分类名称</span></a></span>
                                                        </th>
                                                        <th>
                                                ...
                                                <tbody class="grid_data">
                                                    <asp:Repeater ID="rtpGiftclass" runat="server" OnItemCommand="rtpGiftclass_ItemCommand">
                                                        <ItemTemplate>
                                                            <tr class="pointer" title="">
                                                                <td class="" width="20px">
                                                                    <input class="massaction-checkbox" name="" type="checkbox" value='<%# Eval("ClassId") %>'>
                                                                    </input>
                                                                </td>
                                                                <td class="">
                                                                    <%# Eval("ClassName")%>
                                                                ...
                                                                <td class=" last">
                                                                    <a href='GiftsClassDetail.aspx?id=<%#Eval("ClassId") %>'>编辑</a> |
                                                                    <asp:LinkButton ID="lbdel" runat="server" CommandArgument='<%# Eval("ClassId") %>'
