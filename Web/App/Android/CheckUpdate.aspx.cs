...
public partial class APP_AndriodV2_CheckUpdate : APIPageBase
{
    //数据库中保存最新的版本号
    //传入参数:当前客户端使用的程序版本号
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lastest_version = System.Configuration.ConfigurationManager.AppSettings["UserAndroidAppVersion"].ToString();// "1.0";
