...
<head lang="en">
    ...
    <title>商户版下载 - <%= SectionProxyData.GetSetValue(3)%></title>
</head>

<body>
    <div id="content">
        <input type="hidden" id="androidurl" runat="server" />
        <input type="hidden" id="iphoneurl" runat="server" />
        <div class="tip_wrap">
            ...
            <div id="weibo_tips_ios" name="weibo_tips_ios" class="weibo_tips_ios" style="display: none; text-align: center; padding-top: 20px;"><span style="color: black; font-size: 17px;">请点击右上角,用Safari打开,下载应用</span></div>
            <div id="weibo_tips_android" class="weibo_tips_android" style="display: none; padding-top: 20px; text-align: center;"><span style="color: black; font-size: 17px;">请点击右上角,在浏览器中打开,下载应用</span></div>
