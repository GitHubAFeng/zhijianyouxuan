<%@ Page Language="C#" AutoEventWireup="true" CodeFile="updateWebBasicfix.aspx.cs" Inherits="AreaAdmin_updateWebBasicfix" %>
                                                                ...
                                                                <table class="form-list" cellspacing="0">
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="value">
                                                                                <asp:TextBox ID="FCKContent" Width="400" Height="50" runat="server" TextMode="MultiLine"></asp:TextBox>
                                                                            </td>
                                                                            <td>
                                                                                <small>&nbsp;</small>
                                                                            </td>
