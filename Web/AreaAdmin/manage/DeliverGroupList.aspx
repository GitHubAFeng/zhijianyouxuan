<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DeliverGroupList.aspx.cs" Inherits="qy_54tss_AreaAdmin_delivergroup" %>
                                ...
                                <ContentTemplate>
                                    <div class="main-col-inner">
                                        ...
                                        <div id="Div1" style="clear: both;">
                                            <div align="center" style="background:#6f8992; text-align: center; line-height:24px;
                                                height: 24px;">
                                                <label runat="server" id="mycityname" style="font-size: 14px; color:#fff;">
                                                    分组管理
                                                </label>
                                            </div>
                                        </div>
                                            ...
                                            <div class="hor-scroll">
                                                ...
                                                <div style="text-align: center;" runat="server" id="divadd">
                                                    <table style="clear: both; width: 100%">
                                                        <tr>
                                                            <th style="width: 30%; text-align: center">城市
                                                            </th>
