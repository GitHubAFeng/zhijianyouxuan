<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PptList.aspx.cs" Inherits="AreaAdmin_PptList" %>
                                        ...
                                        <fieldset class="AdminSearchform">
                                            ...
                                            <table border="0" cellpadding="0" cellspacing="0" style="margin-left: 10px;">
                                                <tr>
                                                    ...
                                                    <td>&nbsp;
                                                     <asp:DropDownList ID="ddlReve2" runat="server" CssClass="j_select">
                                                         <asp:ListItem Text="全部位置" Value="-1"></asp:ListItem>
                                                         <asp:ListItem Value="1">商家列表</asp:ListItem>
                                                         <asp:ListItem Value="2">微信首页</asp:ListItem>
                                                         <asp:ListItem Value="3">app首页</asp:ListItem>
                                                        ...
                                                        <tr class="headings">
                                                            ...
                                                            <th>
                                                                <span class="nobr"><a href="#" name="created_at" title="asc" class="not-sort">
                                                                    <!--sort-arrow-desc-->
                                                                    <span class="sort-title">地址</span></a></span>
                                                            </th>
                                                            <th>
                                                            ...
                                                            <th>
                                                                <span class="nobr"><a href="#" name="created_at" title="asc" class="not-sort"><span
                                                                    class="sort-title">位置</span></a></span>
                                                            </th>
                                                        ...
                                                        <asp:Repeater ID="rtpTogolist" runat="server">
                                                            <ItemTemplate>
                                                                <tr class="pointer" title="">
                                                                    ...
                                                                    <td class="">
                                                                        <%#WebUtility.Left(Eval("purl").ToString(), 30)%>
                                                                    </td>
                                                                    <td class="">
                                                                        <%# Eval("Reve1")%>
                                                                    </td>
                                                                    ...
                                                                    <td class=" last">
                                                                        <a href='PptDetail.aspx?id=<%#Eval("DataID") %>'>编辑</a> <span class="separator"></td>
                                                                </tr>
                                                            </ItemTemplate>
                                                        </asp:Repeater>
                                                    </tbody>
