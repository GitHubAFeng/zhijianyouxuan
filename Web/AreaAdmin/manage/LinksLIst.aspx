<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LinksLIst.aspx.cs" Inherits="AreaAdmin_Links" %>
...
<%@ Register Src="~/AreaAdmin/Adleft.ascx" TagName="LinksLIstleft" TagPrefix="uc3" %>
                                ...
                                <div class="main-col-inner">
                                    ...
                                    <div class="scott">
                                        <webdiyer:AspNetPager CssClass="anpager" ID="AspNetPager1" runat="server" Width="100%"
                                            ...
                                            TextBeforePageIndexBox="转到 " PageIndexBoxClass="flattext" ShowPageIndex="True" OnPageChanging="AspNetPager1_PageChanging"
                                    ...
                                    <div id="sales_order_grid_massaction" style="clear: both;">
                                        <table class="massaction" cellpadding="0" cellspacing="0">
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <a href="LinksDitail.aspx">新增友情连接</a>&nbsp;&nbsp; <span class="separator">|<a href="#"
                                                            onclick="javascript:Table.CheckAll()">全选</a> <span class="separator">|</span> <a
                                                                href="#" onclick="javascript:Table.CheckNo()">取消选择</a><span class="separator">|</span>
                                                            <a href="#" onclick="javascript:Table.ReCheck()">反向选择</a><span class="separator">|</span>
                                                            <a href="#" onclick="return false">
                                                                <asp:LinkButton ID="lbDelsom" OnClientClick="return Del()" runat="server" OnClick="lbDelsom_Click">删除选定</asp:LinkButton>
                                                            </a>
                                                    </td>
                                                    <td>
                                                    </td>
                                                ...
                                                <thead>
                                                    <thead>
                                                        <tr class="headings">
                                                            ...
                                                            <th>
                                                                <span class="nobr"><a class="not-sort" href="#" name="real_order_id" title="asc"><span
                                                                    class="sort-title">衔接地址</span></a></span>
                                                            </th>
                                                            <th>
                                                    ...
                                                    <tbody class="grid_data">
                                                        <asp:Repeater ID="rptLinksList" runat="server" OnItemCommand="rptLinksList_OnItemCommand">
                                                            <ItemTemplate>
                                                                <tr class="pointer" title="">
                                                                    <td class="" width="20px">
                                                                        <input class="massaction-checkbox" name="" type="checkbox" value='<%# Eval("LinkID") %>'>
                                                                        </input>
                                                                    </td>
                                                                    <td class="">
                                                                        ...
                                                                        <td class=" last">
                                                                            <a href='LinksDitail.aspx?id=<%#Eval("LinkID") %>'>编辑</a> |<asp:LinkButton ID="lbdel"
                                                                                runat="server" CommandArgument='<%# Eval("LinkID") %>' CommandName="Del" OnClientClick="return DelConfirm();">删除</asp:LinkButton>
                                                                        </td>
                                                                </tr>
                                                            </ItemTemplate>
                                                        </asp:Repeater>
