<%@ Page Language="C#" AutoEventWireup="true" CodeFile="setweixin.aspx.cs" Inherits="AreaAdmin_Shop_setweixin"
                                                                    ...
                                                                    <table class="form-list" cellspacing="0">
                                                                        <tbody>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td class="value">
                                                                                    <epc:TextBox runat="server" ID="tbAppSecret" TextMode="Password" CanBeNull="必填" name="invalue" Width="360"
                                                                                        class=" required-entry required-entry input-text"></epc:TextBox>
                                                                                </td>
                                                                                <td>
                                                                                    <small>&nbsp;</small>
                                                                    ...
                                                                    <table class="form-list" cellspacing="0">
                                                                        <tbody>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td class="value">
                                                                                    <epc:TextBox runat="server" ID="tbapikey" TextMode="Password" name="invalue" Width="360"
                                                                                        class=" required-entry required-entry input-text"></epc:TextBox>
                                                                                </td>
                                                                                <td>
                                                                                    <small>&nbsp;</small>
