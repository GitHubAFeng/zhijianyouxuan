<%@ Page Language="C#" AutoEventWireup="true" CodeFile="shopStatisticsYear.aspx.cs"
    Inherits="AreaAdmin_Sale_shopStatisticsYear" %>
...
<head id="Head1" runat="server">
    <title>月度商家汇总－<%= WebUtility.GetMyName()%></title>
                                                        ...
                                                        <div class="content">
                                                            <div class="hor-scroll">
                                                                ...
                                                                <span runat="server" id="lbnotice" style="margin-top: 10px; margin-bottom: 5px; color: Red;
                                                                    font-weight: bold;">点击商家查看当月每日财务</span>
                                                                        ...
                                                                        <asp:Repeater runat="server" ID="rptsum" OnItemCommand="getdays">
                                                                            <ItemTemplate>
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="tableft">
                                                                                       <a href="<%# geturl( Eval("Unid")) %>"> <%# Eval("Name")%></a>
                                                                                    </td>
                                                                                    <td class="tableft">
