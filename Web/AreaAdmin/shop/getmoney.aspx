<%@ Page Language="C#" AutoEventWireup="true" CodeFile="getmoney.aspx.cs" Inherits="AreaAdmin_Shop_getmoney" %>
...
<head id="Head1" runat="server">
    <title>商家统计－<%= WebUtility.GetMyName()%></title>
                                    ...
                                    <div style="visibility: visible;" class="content-header">
                                        ...
                                        <div style="width: 0px; height: 17px;" class="content-buttons-placeholder">
                                            <p style="" class="content-buttons form-buttons">
                                                <asp:Button ID="btSave" runat="server" CssClass="button_1" OnClientClick=" window.history.go(-1); return false;"
                                                    Text="返回列表" style=" margin-left:20px;"></asp:Button>
                                                <asp:Button ID="Button1" runat="server" CssClass="button_1" OnClick="goshop_Click"
                                                    Text="返回商家" style=" margin-left:20px;"></asp:Button>
                                            </p>
                                        </div>
                                    </div>
                                    <!--start-->
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="value">
                                                                                <asp:DropDownList runat="server" ID="ddlOrderState" Width="100px">
                                                                                    ...
                                                                                    <asp:ListItem Text="已打印" Value="2"></asp:ListItem>
                                                                                    <asp:ListItem Text="已完成" Value="3"></asp:ListItem>
                                                                                    <asp:ListItem Text="退单" Value="5"></asp:ListItem>
                                                                                    <asp:ListItem Text="配送中" Value="7"></asp:ListItem>
                                                                                    <asp:ListItem Text="已处理" Value="8"></asp:ListItem>
                                                                                </asp:DropDownList>
                                                                                <td>
                                                                                    <span>&nbsp;</span>
                                                                                </td>
