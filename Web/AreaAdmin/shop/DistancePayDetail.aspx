<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DistancePayDetail.aspx.cs" Inherits="AreaAdmin_shop_DistancePayDetail" %>
...
<head id="Head1" runat="server">
    <title>配送范围信息管理-<%= WebUtility.GetMyName()%></title>
...
<body>
                                                                ...
                                                                <table class="form-list" cellspacing="0">
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            <td class="label">
                                                                                <label for="_accountprefix">
                                                                                    配送范围<span class="required">*</span></label>
                                                                            </td>
                                                                            <td class="value" style="width:200px;">
                                                                                <epc:TextBox runat="server" ID="tbdistancestart" CanBeNull="必填" RequiredFieldType="数据校验" Width="60px" 
                                                                                    class=" required-entry required-entry input-text"></epc:TextBox>&nbsp;&nbsp;-&nbsp;&nbsp;<epc:TextBox runat="server" ID="tbdistanceend" CanBeNull="必填" RequiredFieldType="数据校验" Width="60px" 
                                                                                    class=" required-entry required-entry input-text"></epc:TextBox>&nbsp;&nbsp;公里
                                                                            </td>
                                                                            <td>
                                                                                <small>&nbsp;</small>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            <td class="label">
                                                                                <label for="_accountprefix">
                                                                                    起送价<span class="required">*</span></label>
                                                                            </td>
                                                                            <td class="value">
                                                                                <epc:TextBox runat="server" ID="tbminmoney" CanBeNull="必填" RequiredFieldType="数据校验"  Width="60px"
                                                                        ...
                                                                        <tr>
                                                                            <td class="label">
                                                                                <label for="_accountprefix">
                                                                                    配送费<span class="required">*</span></label>
                                                                            </td>
                                                                            <td class="value">
                                                                                <epc:TextBox runat="server" ID="tbsendmoney" CanBeNull="必填" RequiredFieldType="数据校验"  Width="60px"
                                                                                    class=" required-entry required-entry input-text"></epc:TextBox>&nbsp;&nbsp; 元
                                                                            </td>
                                                                            <td>
                                                                                <small>&nbsp;</small>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function GotoFoodSortList() {
            window.location.href = "DistancepayList.aspx?tid=" + document.getElementById("hidTogoId").value + "";
        }
    </script>
