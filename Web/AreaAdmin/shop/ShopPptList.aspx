<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ShopPptList.aspx.cs" Inherits="AreaAdmin_shop_ShopPptList" %>
...
<head id="Head1" runat="server">
    <title>商家幻灯片信息表 -<%= WebUtility.GetMyName()%></title>
                                    ...
                                    <fieldset class="AdminSearchform">
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" style="margin-left: 10px;">
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:Button ID="btSearch" runat="server" style=" margin-left:10px;" class="form-button" Text="搜索" OnClick="btSearch_Click" />
                                            ...
                                            <table class="data" cellspacing="0" id="grid_table">
                                                ...
                                                <thead>
                                                        ...
                                                        <tr class="headings">
                                                            ...
                                                            <th>
                                                                <span class="nobr"><a class="not-sort" href="#" name="store_id" title="asc"><span
                                                                    class="sort-title">序号</span></a></span>
                                                            </th>
                                                    ...
                                                    <tbody class="grid_data">
                                                        <asp:Repeater ID="Rptshoppic" runat="server" OnItemCommand="rptToGoAd_ItemCommand">
                                                            <ItemTemplate>
                                                                <tr class="pointer" title="">
                                                                    ...
                                                                    <td class="">
                                                                     <a href='ShopPptDetail.aspx?id=<%#Eval("DataId") %>'> <%# WebUtility.Left(Eval("TogoName"),15)%></a>
                                                                    </td>
                                                                    <td class="">
                                                                        <%# Eval("Pri")%>
                                                                    </td>
                                                                    <td class=" last">
                                                                        <a href='ShopPptDetail.aspx?id=<%#Eval("DataId") %>'>编辑</a> |<asp:LinkButton
