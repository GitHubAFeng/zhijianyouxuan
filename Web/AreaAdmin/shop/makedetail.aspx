<%@ Page Language="C#" AutoEventWireup="true" CodeFile="makedetail.aspx.cs" Inherits="qy_54tss_AreaAdmin_aboutus_makedetail" %>
...
<head id="Head1" runat="server">
    <title>口味详情管理-<%= WebUtility.GetMyName()%></title>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function GotoADList() {
            var tid = request("tid");
            window.location.href = "makelist.aspx?tid=" + tid;
        }
    </script>
                                            ...
                                            <div id="customer_info_tabs_account_content" style="">
                                                <div class="entry-edit">
                                                    <div class="entry-edit-head">
                                                        <h4 class="icon-head head-billing-address">口味详情管理</h4>
                                                    </div>
                                                    <fieldset class="np">
                                                                            ...
                                                                            <tr>
                                                                                <td class="label">
                                                                                    <label for="_accountfirstname">
                                                                                        口味<span class="required">*</span></label>
                                                                                </td>
                                                                                <td class="value">
                                                                                    <epc:TextBox runat="server" ID="tbpname"  CanBeNull="必填" Width="260px" class=" required-entry required-entry input-text"></epc:TextBox>
                                                                                </td>
                                                                                <td>
                                                                                    <small>&nbsp;</small>
                                                                                </td>
