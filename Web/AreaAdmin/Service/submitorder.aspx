<%@ Page Language="C#" AutoEventWireup="true" CodeFile="submitorder.aspx.cs" Inherits="qy_54tss_AreaAdmin_Service_submitorder" %>
                            ...
                            <ContentTemplate>
                                <div>
                                    ...
                                    <div class="dish_type_unit">
                                            ...
                                            <ItemTemplate>
                                                <div class="sortitem">
                                                    ...
                                                    <ul class="hdish_ul_sub">
                                                        <li><span style="width: 35%">菜品</span> <span style="width: 10%">单价</span> <span style="width: 10%">加价</span> <span style="width: 10%">数量</span> <span style="width: 15%">小计</span><span style="width: 15%">&nbsp;</span>
                                                        </li>
                                                        <asp:Repeater runat="server" ID="rptFoodList" DataSource='<%# Eval("ItemList") %>'>
                                                            <ItemTemplate>
                                                                <li><span style="width: 35%"><a href="javascript:void(0)" title="<%#Eval("PName")%>"><%#Eval("PName")%></a></span> <span style="width: 10%">￥<%#  Convert.ToDecimal(Eval("PPrice")) %></span> <span style="width: 10%">￥<%#  Convert.ToDecimal(Eval("addprice")) %></span>
                                                                    <span style="width: 10%">
                                                                        <%#Eval("pnum")%></span> <span style="width: 15%">￥<%# ( Convert.ToDecimal(Eval("PPrice")) + Convert.ToDecimal(Eval("addprice")))　 * Convert.ToInt32(Eval("pnum"))%></span>
                                        ...
                                        <div class="sortitem">
                                            <ul class="hdish_ul_sub">
                                                <li><span style="width: 30%">送餐费：<label runat="server" id="lbsendmony"></label>元</span>
                                                    <span style="width: 30%">份数：<label runat="server" id="lbnum"></label></span> <span
                                                        style="width: 30%">总金额：<label runat="server" id="lballmoney"></label>元</span>
                                                </li>
                                            </ul>
                                        </div>
