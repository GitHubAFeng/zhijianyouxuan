<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OrderCrm.aspx.cs" Inherits="qy_54tss_AreaAdmin_GpsSet_OrderCrm" %>
            ...
            <div class="indis_right">
                    ...
                    <ContentTemplate>
                        <div class="indis_right_top" id="shopdiv">
                            ...
                            <div class="infaq_list_con">
                                ...
                                <div style="display: none; width: 710px" id="divnocord" runat="server">
                                    <div class="list_ck_shop_no">
                                        <p>
                                            抱歉，没有找到相关的商家。</p>
                                    </div>
                                </div>
                                <div style="width: 710px" id="div_notice" runat="server">
                                    <div class="list_ck_shop_notice">
                                        <p>
                                            请搜索商家名称</p>
                                    </div>
                                </div>
                ...
                <div class="indis_right_top" runat="server" id="mapdiv" style=" visibility:hidden;">
                    <div style="padding-left: 20px; margin: 10px;">
                        <a class="infaq_address_sure_btn" href="javascript:hide_map()" style="float: right;
                            padding-right: 10px;">关闭地图</a>
                        <div class="mynotice">
                            提示：拖动标准修改用户的位置</div>
                    </div>
...
<script src="javascript/map.js?v=0218" type="text/javascript"></script>
