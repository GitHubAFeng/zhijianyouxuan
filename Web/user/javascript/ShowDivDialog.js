...
function tipsWindown(title,content,width,height,drag,time,showbg,cssName)
{
	...
	if(showWindown == true) 
	{
		var simpleWindown_html = new String;
			simpleWindown_html = "<div id=\"windownbg\" style=\"height:"+$(document).height()+"px;filter:alpha(opacity=0.2);opacity:0.2;z-index: 999901\"></div>";
	...
	if( time == "" || typeof(time) == "undefined" || 1==1) 
	{
