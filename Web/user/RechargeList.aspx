<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RechargeList.aspx.cs" Inherits="UserHome_RechargeList" %>
...
<head id="Head1" runat="server">
    ...
    <title>充值记录-<%= WebUtility.GetWebName()%></title>
    ...
    <link href="../css/common.css" rel="stylesheet" type="text/css" />
    <%-- <link href="../css/regist_commom.css" rel="stylesheet" type="text/css" />
    <link href="../css/uc_common.css" rel="stylesheet" type="text/css" />--%>
        ...
        <div class="warp_con">
            ...
            <div class="rightmenu_cont">
                <div class="rightmenu_cen">
                    <h1 class="topbg">充值记录</h1>
                    <div class="listorder">
                        <ul>
                            <li><span>
                                <asp:Label runat="server" ID="lbUserName"></asp:Label></span> 您好，您的帐户中目前共有 <span class="orange">
                                    <asp:Label
                                        ...
                                        <asp:Repeater ID="rptPointCount" runat="server">
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <%# Eval("paytype").ToString() == "1" ? Eval("inve2").ToString() : Eval("dataid").ToString()%>
                                                    </td>
                                                </tr>
                                            </ItemTemplate>
                                        </asp:Repeater>
