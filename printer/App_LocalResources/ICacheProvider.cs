...
public interface ICacheProvider
{
    ...
    /// </summary>
    /// <returns></returns>
    DataTable GetTogoNameAndId();

    /// <summary>
    /// 设置商家名称和编号的缓存
    /// </summary>
    void SetTogoNameAndId(DataTable dt);

    /// <summary>
    /// 清空商家名称和编号的缓存
    /// </summary>
    void ClearTogoNameAndId();

    /// <summary>
    /// 获取来电客户信息
    /// </summary>
    /// <returns></returns>
    DataTable GetCustomerDB();

    /// <summary>
    /// 设置来电客户信息
    /// </summary>
    void SetCustomerDB(DataTable dt);

    /// <summary>
    /// 清空来电客户信息
    /// </summary>
    void ClearCustomerDB();

    /// <summary>
    /// 获取超市名称和编号的缓存 超市名称补全中使用
    /// </summary>
    /// <returns></returns>
    DataTable GetMarketNameAndId();

    /// <summary>
    /// 设置超市名称和编号的缓存
    /// </summary>
    void SetMarketNameAndId(DataTable dt);

    /// <summary>
    /// 清空超市名称和编号的缓存
    /// </summary>
    void ClearMarketNameAndId();
}
