...
public class CacheProvider : ICacheProvider
{
    ...
    /// <summary>
    /// 获取商家名称和编号的缓存 商家名称补全中使用
    /// </summary>
    /// <returns></returns>
    public DataTable GetTogoNameAndId()
    {

        DataTable dt = new DataTable("TogoNameId");
    ...
    /// 设置商家名称和编号的缓存
    /// </summary>
    public void SetTogoNameAndId(DataTable dt)
    {
        lock (_togoNameId)
        {
            _togoNameId = dt;
    ...
    /// 清空商家名称和编号的缓存
    /// </summary>
    public void ClearTogoNameAndId()
    {
        lock (_togoNameId)
        {
            _togoNameId.Clear();
    ...
    /// </summary>
    /// <returns></returns>
    public DataTable GetCustomerDB()
    {

        DataTable dt = new DataTable("CustomerDB");
    ...
    /// 设置来电客户信息
    /// </summary>
    public void SetCustomerDB(DataTable dt)
    {
        lock (_customerDB)
        {
            _customerDB = dt;
    ...
    /// <summary>
    /// 获取超市名称和编号的缓存 超市名称补全中使用
    /// </summary>
    /// <returns></returns>
    public DataTable GetMarketNameAndId()
    {

        DataTable dt = new DataTable("MarketNameId");
    ...
    /// 设置超市名称和编号的缓存
    /// </summary>
    public void SetMarketNameAndId(DataTable dt)
    {
        lock (_marketNameId)
        {
            _marketNameId = dt;
    ...
    /// 清空超市名称和编号的缓存
    /// </summary>
    public void ClearMarketNameAndId()
    {
        lock (_marketNameId)
        {
            _marketNameId.Clear();
